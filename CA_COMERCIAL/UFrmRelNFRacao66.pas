...
//    RLSaveDialogSetup1: TRLSaveDialogSetup;
    ...
    RLCnpj: TRLLabel;
    RLIe: TRLLabel;
    qryNotaFiscGN_OBSEPEDIVEND: TStringField;
    qryNotaFiscGN_OBSEEXPEPEDIVEND: TStringField;
    RLDBMemo2: TRLDBMemo;
...
var
  FrmRelNFRacao66: TFrmRelNFRacao66;
...
procedure TFrmRelNFRacao66.RL_NotasBeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
