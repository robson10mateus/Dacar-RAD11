object FrmConferenciaCarga: TFrmConferenciaCarga
  Left = 478
  Top = 184
  ...
  object Qr: TOraQuery
    ...
    SQL.Strings = (
      ...
      '&Macro '
      ''
      'ORDER BY E.DT_CARGEXPE DESC,  E.NR_ORDEENTRCARGEXPE')
    FetchAll = True
    CachedUpdates = True
    Left = 108
    Top = 3
    ...
    object QrNR_ORDEENTRCARGEXPE: TFloatField
      FieldName = 'NR_ORDEENTRCARGEXPE'
      Required = True
    end
  end
