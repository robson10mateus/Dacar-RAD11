object FrmCartorio: TFrmCartorio
  ...
  object Panel1: TPanel
    ...
    object Label2: TLabel
      ...
      Width = 111
      Height = 15
      Caption = 'T'#237'tulos Protestados'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = 15
      Font.Name = 'Arial'
  ...
  object QRcartorio: TOraQuery
    ...
    SQL.Strings = (
      ...
      ' AND  id_cliente = :VCLIENTE'
      'order by dt_enviocartorio'
      '')
    Left = 184
    Top = 32
    ParamData = <
    ...
    object QRcartorioDT_ENVIOCARTORIO: TDateTimeField
      DisplayLabel = 'Data Pagto. em Cart'#243'rio'
      FieldName = 'DT_ENVIOCARTORIO'
    end
    object QRcartorioID_CONTA: TFloatField
      DisplayLabel = 'C'#243'd. Conta'
      FieldName = 'ID_CONTA'
    end
    object QRcartorioROCORCOBR: TStringField
      DisplayLabel = 'C'#243'd. Ocorr'#234'ncia'
      FieldName = 'ROCORCOBR'
      Size = 2
    end
  end
  object DSCARTORIO: TOraDataSource
    DataSet = QRcartorio
    Left = 232
    Top = 32
  end
