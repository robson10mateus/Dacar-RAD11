object FrmCadRegiao: TFrmCadRegiao
  Left = 486
  Top = 197
  Width = 1086
  Height = 471
  ...
  object PageControl2: TPageControl
    ...
    object TabDetalhe: TTabSheet
      ...
      object DBidRegiao: TDBEdit
        Left = 1
        Top = 32
        Width = 80
        Height = 23
        DataField = 'ID_REGIAO'
        DataSource = dtsRegiao
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = 15
        Font.Name = 'Arial'
    ...
    object TabCidade: TTabSheet
      ...
      object GroupBox1: TGroupBox
        ...
        object btnPesqCid: TBitBtn
          ...
          ParentFont = False
          TabOrder = 0
          OnClick = btnPesqCidClick
        end
        object edtPesqCid: TEdit
          Left = 11
          Top = 29
          Width = 246
          Height = 23
  ...
  object qryConsulta: TOraQuery
    Session = FrmPrincipal.DB
    SQL.Strings = (
      'SELECT DISTINCT H.ID_REGIAO, H.NM_REGIAO, Y.ID_CIDADE'
      'FROM DACAR_CIDADE_REG Y'
      'RIGHT JOIN DACAR_REGIAO_LOGISTICA H ON H.ID_REGIAO = Y.ID_REGIAO'
      'ORDER BY H.ID_REGIAO ')
    Left = 573
    Top = 8
    object qryConsultaID_REGIAO: TFloatField
      FieldName = 'ID_REGIAO'
      Required = True
    end
    object qryConsultaNM_REGIAO: TStringField
      FieldName = 'NM_REGIAO'
      Size = 100
    end
    object qryConsultaID_CIDADE: TFloatField
      FieldName = 'ID_CIDADE'
      Required = True
    end
  end
