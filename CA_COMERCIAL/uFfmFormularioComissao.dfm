object frmFormularioComissao: TfrmFormularioComissao
  Left = 447
  Top = 222
  Width = 1198
  Height = 642
  HorzScrollBar.Range = 806
  VertScrollBar.Range = 1138
  Caption = 'Comercial Dacar - Formul'#225'rio de Comiss'#227'o'
  Color = clBackground
  ...
  PixelsPerInch = 96
  TextHeight = 15
  object rptFormularioComissao: TRLReport
    Left = 12
    Top = 15
    Width = 794
    Height = 1123
    DataSource = dtsFormularioComissao
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clBlack
    Font.Height = 11
    Font.Name = 'Arial'
    ...
    object Cabecalho: TRLBand
      ...
      object lblSubTitulo: TRLLabel
        ...
        Alignment = taCenter
        AutoSize = False
        Caption = 'Autoriza'#231#227'o de Comiss'#227'o  - Porcentagem (%)'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = 16
        Font.Name = 'Arial'
    ...
    object RLBand1: TRLBand
      ...
      object RLLabel10: TRLLabel
        ...
        Width = 225
        Height = 19
        Caption = 'Visita realizada pelo Supervisor'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = 16
        Font.Name = 'Tahoma'
      ...
      object RLLabel18: TRLLabel
        ...
        AutoSize = False
        Caption = 
          'Obs: Somente porcentagem acima de 1% dever'#225' ter a assinatura da ' +
          'Diretoria.'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = 11
      ...
      object lblClienteNovo: TRLLabel
        Left = 193
        Top = 48
        Width = 25
        Height = 23
  ...
  object qryFormularioComissao: TOraQuery
    SQL.Strings = (
      'SELECT C.ID_CLIENTE, C.NM_CLIENTE,'
      '    CASE WHEN C.FL_PESSCLIE = '#39'F'#39' THEN'
      '        C.NR_CPFCLIE '
      '    ELSE'
      '        C.NR_CNPJCLIE'
      '    END AS CNPJ_CPF,'
      'V.ID_VENDEDOR || '#39' - '#39' || V.NM_VENDEDOR AS VENDEDOR,'
      '    CASE WHEN C.FL_RESGATADO = '#39'S'#39' THEN'
      '        C.FL_RESGATADO '
      '    ELSE'
      '        '#39'N'#39
      '    END AS RESGATADO,'
      'C.FL_RESGATADO,'
      'R.ID_VENDEDOR || '#39' - '#39' || R.NM_VENDEDOR AS VENDEDOR_RESG    '
      'FROM CLIENTE C'
      
        'LEFT OUTER JOIN CLIENTE_VENDEDOR CV ON (CV.ID_CLIENTE = C.ID_CLI' +
        'ENTE AND CV.FL_PADRVENDCLIE = '#39'S'#39')'
      'LEFT OUTER JOIN VENDEDOR V ON (V.ID_VENDEDOR = CV.ID_VENDEDOR)'
      
        'LEFT OUTER JOIN VENDEDOR R ON (R.ID_VENDEDOR = C.ID_USUARIO_RESG' +
        ')'
    ...
    object qryFormularioComissaoID_CLIENTE: TFloatField
      FieldName = 'ID_CLIENTE'
      Required = True
    end
    object qryFormularioComissaoNM_CLIENTE: TStringField
      FieldName = 'NM_CLIENTE'
      Size = 60
    end
    object qryFormularioComissaoCNPJ_CPF: TStringField
      FieldName = 'CNPJ_CPF'
      Size = 14
    end
    object qryFormularioComissaoVENDEDOR: TStringField
      FieldName = 'VENDEDOR'
      Size = 83
    end
    object qryFormularioComissaoFL_RESGATADO: TStringField
      FieldName = 'FL_RESGATADO'
      Size = 1
    end
    object qryFormularioComissaoVENDEDOR_RESG: TStringField
      FieldName = 'VENDEDOR_RESG'
      Size = 83
    end
    object qryFormularioComissaoRESGATADO: TStringField
      FieldName = 'RESGATADO'
      Size = 1
    end
  end
  object dtsFormularioComissao: TOraDataSource
    DataSet = qryFormularioComissao
    Left = 19
    Top = 84
  end
end
