object FrmSaldoProdCorte: TFrmSaldoProdCorte
  Left = 423
  Top = 189
  Width = 609
  Height = 388
  VertScrollBar.Range = 72
  ...
  object qrSaldo: TOraQuery
    SQL.Strings = (
      ...
      '  sum(pedido_venda_item.qn_pesoitempedivend) as total_peso'
      'FROM'
      '  PEDIDO_VENDA_ITEM,'
      '  PEDIDO_VENDA,'
      '  PEDIDO_VENDA_TIPO,'
      ...
      '  AND VENDEDOR.ID_USUARIO = :P_ID_USUARIO'
      'GROUP BY'
      '  Material_embalagem.ID_PRODMATEEMBA,'
      '  Material_embalagem.NM_PRODMATEEMBA'
      'ORDER BY 3')
    ...
    object qrSaldoID_PRODMATEEMBA: TStringField
      FieldName = 'ID_PRODMATEEMBA'
      Size = 5
    end
    object qrSaldoNM_PRODMATEEMBA: TStringField
      FieldName = 'NM_PRODMATEEMBA'
      Size = 40
    end
    object qrSaldoDIFERENCA: TFloatField
      FieldName = 'DIFERENCA'
      DisplayFormat = '#,##0.00'
    end
    object qrSaldoTOTAL: TFloatField
      FieldName = 'TOTAL'
      DisplayFormat = '#,##0.00'
    end
    object qrSaldoTOTAL_PESO: TFloatField
      FieldName = 'TOTAL_PESO'
    end
  end
end
