object FrmSelQuebr: TFrmSelQuebr
  Left = 155
  Top = 130
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'PESO_ENTR'
            Title.Caption = 'Kg. Entreg.'
            Width = 80
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'KG_TOTAQUEB'
            Title.Caption = 'Kg. Quebr.'
            Width = 80
            Visible = True
          end
          item
  ...
  object Qr: TOraQuery
    ...
    SQL.Strings = (
      'SELECT    PEDIDO_VENDA.DT_ENTRPEDIVEND,'
      '          EXPEDICAO_CARGA.ID_CARGEXPE,'
      '          EXPEDICAO_CARGA.GN_PLACVEICTRAN,'
      '          FORNECEDOR.NM_FORNECEDOR,'
      
        '          PEDIDO_VENDA_ITEM.QN_PESOPADREXPEITEMPEDIVEND AS PESO_' +
        'EXP,'
      
        '          PEDIDO_DEVOLUCAO_VENDA_ITEM.QN_PESOITEMPEDIDEVOVEND AS' +
        ' PESO_DEV,'
      
        '          (PEDIDO_VENDA_ITEM.QN_PESOPADREXPEITEMPEDIVEND - PEDID' +
        'O_DEVOLUCAO_VENDA_ITEM.QN_PESOITEMPEDIDEVOVEND) AS PESO_ENTR,'
      ''
      
        '         PEDIDO_DEVOLUCAO_VENDA_ITEM.QN_PESOQUEBITEMPEDIDEVOVEND' +
        ' AS KG_TOTAQUEB,'
      
        '         round((DECODE(PEDIDO_VENDA_ITEM.QN_PESOPADREXPEITEMPEDI' +
        'VEND - PEDIDO_DEVOLUCAO_VENDA_ITEM.QN_PESOITEMPEDIDEVOVEND,'
      ...
      '         FORNECEDOR'
        ...
        '         ( PEDIDO_VENDA_ITEM.ID_PEDIVEND = PEDIDO_VENDA.ID_PEDIV' +
        'END ) and'
      
        '         ( PEDIDO_VENDA.ID_CARGEXPE = EXPEDICAO_CARGA.ID_CARGEXP' +
        'E ) and'
      
        '         ( EXPEDICAO_CARGA.ID_ITEMPROGCAMI = FORNECEDOR.ID_FORNE' +
        'CEDOR ) and'
      '          TRUNC(PEDIDO_VENDA.DT_ENTRPEDIVEND) >= :DTINI AND'
      '          TRUNC(PEDIDO_VENDA.DT_ENTRPEDIVEND) <= :DTFIM '
      ''
      '&Macro')
    Left = 544
    Top = 16
    ...
    object QrPESO_EXP: TFloatField
      FieldName = 'PESO_EXP'
      Required = True
    end
    object QrPESO_DEV: TFloatField
      FieldName = 'PESO_DEV'
    end
    object QrKG_TOTAQUEB: TFloatField
      FieldName = 'KG_TOTAQUEB'
    end
    object QrQN_PERCQUEB: TFloatField
      FieldName = 'QN_PERCQUEB'
    end
    ...
    object QrPESO_ENTR: TFloatField
      FieldName = 'PESO_ENTR'
    end
  end
