...
uses
  ...
  Grids, DBGrids, DB, Ora, MemDS, Global, DBAccess, DateUtils, OraSmart;
...
type
  TfrmReprogramarDevolucao = class(TForm)
    ...
    qryPedidoVendaItemNovo: TSmartQuery;
    qryPedidoVendaNovo: TSmartQuery;
    qryPedidoVendaBase: TSmartQuery;
