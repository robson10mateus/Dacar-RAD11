object FrmRelEstoquePeriodo: TFrmRelEstoquePeriodo
  Left = 427
  Top = 225
  Width = 1305
  Height = 675
  ...
  object RLReport1: TRLReport
    ...
    object RLBand3: TRLBand
      ...
      object RLDBText3: TRLDBText
        ...
        Alignment = taRightJustify
        AutoSize = False
        DataField = 'ESTOQUE_ANT_CX'
        DataSource = dtsSaldoAnterior
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = 9
        Font.Name = 'Arial'
      ...
      object RLDBText13: TRLDBText
        ...
        Alignment = taRightJustify
        AutoSize = False
        DataField = 'NVL(PE.KG_ESTOQUE_ATUAL,0)'
        DataSource = dtsSaldoDisponivel
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = 9
        Font.Name = 'Arial'
      ...
      object RLDBText14: TRLDBText
        ...
        Alignment = taRightJustify
        AutoSize = False
        DataField = 'NVL(PE.CX_ESTOQUE_ATUAL,0)'
        DataSource = dtsSaldoDisponivel
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = 9
  ...
  object qryEstoquePeriodo: TOraQuery
    KeyFields = 'ID_MATERIAL'
    Session = FrmPrincipal.DB
    SQL.Strings = (
      
        'SELECT  PE.EMPRESA, PE.FILIAL, PE.ID_MATERIAL, PE.ID_PRODMATEEMB' +
        'A, ME.NM_PRODMATEEMBA,'
      
        '       SUM(PE.CX_PRODUZIDO) AS CX_PRODUZIDO, SUM(PE.PRODUZIDO) A' +
        'S KG_PRODUZIDO, '
      
        '       SUM(PE.CX_DEVOLUCAO) AS CX_DEVOLUCAO, SUM(PE.DEVOLUCAO) A' +
        'S KG_DEVOLUCAO, '
      
        '       SUM(PE.CX_EXPEDIDO) AS CX_EXPEDIDO, SUM(PE.EXPEDIDO) AS K' +
        'G_EXPEDIDO,'
      
        '       NVL(SUM(AE.CX_AJUSTE),0) AS CX_AJUSTE, NVL(SUM(AE.QTD_AJU' +
        'STE),0) AS KG_AJUSTE'
      'FROM POSICAO_ESTOQUE PE'
        ...
        'ATEEMBA AND PE.ID_MATERIAL = AE.ID_MATERIAL AND PE.DATA =  AE.DA' +
        'TA)'
      'WHERE (PE.DATA BETWEEN :Data_Ini AND :Data_Fin) AND TIPO <> '#39'F'#39
      
        'GROUP BY PE.EMPRESA, PE.FILIAL, PE.ID_MATERIAL, PE.ID_PRODMATEEM' +
        'BA, ME.NM_PRODMATEEMBA'
      'ORDER BY PE.ID_PRODMATEEMBA')
    DetailFields = 'ID_MATERIAL'
    CachedUpdates = True
    Active = True
    Left = 47
    Top = 14
    ...
    object qryEstoquePeriodoEMPRESA: TStringField
      FieldName = 'EMPRESA'
      Required = True
      Size = 2
    end
    object qryEstoquePeriodoFILIAL: TIntegerField
      FieldName = 'FILIAL'
      Required = True
    end
    object qryEstoquePeriodoID_MATERIAL: TFloatField
      FieldName = 'ID_MATERIAL'
      Required = True
    end
    object qryEstoquePeriodoID_PRODMATEEMBA: TStringField
      FieldName = 'ID_PRODMATEEMBA'
      Required = True
      Size = 5
    end
    object qryEstoquePeriodoNM_PRODMATEEMBA: TStringField
      FieldName = 'NM_PRODMATEEMBA'
      Size = 40
    end
    object qryEstoquePeriodoCX_PRODUZIDO: TFloatField
      FieldName = 'CX_PRODUZIDO'
    end
    object qryEstoquePeriodoKG_PRODUZIDO: TFloatField
      FieldName = 'KG_PRODUZIDO'
      DisplayFormat = '#,##0.000'
    end
    object qryEstoquePeriodoCX_DEVOLUCAO: TFloatField
      FieldName = 'CX_DEVOLUCAO'
    end
    object qryEstoquePeriodoKG_DEVOLUCAO: TFloatField
      FieldName = 'KG_DEVOLUCAO'
      DisplayFormat = '#,##0.000'
    end
    object qryEstoquePeriodoCX_EXPEDIDO: TFloatField
      FieldName = 'CX_EXPEDIDO'
    end
    object qryEstoquePeriodoKG_EXPEDIDO: TFloatField
      FieldName = 'KG_EXPEDIDO'
      DisplayFormat = '#,##0.000'
    end
    object qryEstoquePeriodoCX_AJUSTE: TFloatField
      FieldName = 'CX_AJUSTE'
    end
    object qryEstoquePeriodoKG_AJUSTE: TFloatField
      FieldName = 'KG_AJUSTE'
      DisplayFormat = '#,##0.000'
    end
  end
  object dtsEstoquePeriodo: TOraDataSource
    DataSet = qryEstoquePeriodo
    Left = 20
    Top = 15
  end
  object dtsSaldoAnterior: TOraDataSource
    DataSet = qrySaldoAnterior
    Left = 150
    Top = 3
  end
  object qrySaldoAnterior: TOraQuery
    Session = FrmPrincipal.DB
    SQL.Strings = (
      
        'SELECT PE.ID_MATERIAL, PE.ID_PRODMATEEMBA, PE.ESTOQUE_ANT_CX, PE' +
        '.ESTOQUE_ANT'
      'FROM POSICAO_ESTOQUE PE'
      
        'WHERE (PE.DATA = :Data_Ini) AND TIPO <> '#39'F'#39' AND PE.ID_MATERIAL =' +
        ' :Material AND PE.ID_PRODMATEEMBA = :Produto'
      'ORDER BY PE.DATA, PE.ID_PRODMATEEMBA')
    MasterSource = dtsEstoquePeriodo
    ...
    object qrySaldoAnteriorID_MATERIAL: TFloatField
      FieldName = 'ID_MATERIAL'
      Required = True
    end
    object qrySaldoAnteriorID_PRODMATEEMBA: TStringField
      FieldName = 'ID_PRODMATEEMBA'
      Required = True
      Size = 5
    end
    object qrySaldoAnteriorESTOQUE_ANT_CX: TFloatField
      FieldName = 'ESTOQUE_ANT_CX'
    end
    object qrySaldoAnteriorESTOQUE_ANT: TFloatField
      FieldName = 'ESTOQUE_ANT'
      DisplayFormat = '#,##0.000'
    end
  end
  object dtsSaldoDisponivel: TOraDataSource
    DataSet = qrySaldoDisponivel
    Left = 214
    Top = 2
  end
  object qrySaldoDisponivel: TOraQuery
    Session = FrmPrincipal.DB
    SQL.Strings = (
      
        'SELECT PE.ID_MATERIAL, PE.ID_PRODMATEEMBA, NVL(PE.CX_ESTOQUE_ATU' +
        'AL,0), NVL(PE.KG_ESTOQUE_ATUAL,0)'
      'FROM POSICAO_ESTOQUE PE'
      
        'WHERE (PE.DATA = :Data_Fin) AND TIPO <> '#39'F'#39' AND PE.ID_MATERIAL =' +
        ' :Material AND PE.ID_PRODMATEEMBA = :Produto '
      'ORDER BY PE.DATA, PE.ID_PRODMATEEMBA')
    MasterSource = dtsEstoquePeriodo
    MasterFields = 'ID_MATERIAL'
    ...
    object qrySaldoDisponivelNVLPECX_ESTOQUE_ATUAL0: TFloatField
      FieldName = 'NVL(PE.CX_ESTOQUE_ATUAL,0)'
      DisplayFormat = '#,##0.000'
    end
    object qrySaldoDisponivelNVLPEKG_ESTOQUE_ATUAL0: TFloatField
      FieldName = 'NVL(PE.KG_ESTOQUE_ATUAL,0)'
    end
  end
end
