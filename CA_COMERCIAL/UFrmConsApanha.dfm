object FrmConsApanha: TFrmConsApanha
  Left = 211
  Top = 186
    ...
    object Tab_Lista: TTabSheet
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'QTD_PREVISAO'
            Title.Caption = 'Qtde Previs'#227'o'
            Visible = True
          end
          item
            Expanded = False
  ...
  object Qr: TOraQuery
    ...
    SQL.Strings = (
      'Select NF.DT_SAIDNOTAFISC, NF.NR_NOTAFISC,'
      '       C.NM_CLIENTE, NF.GN_PLACVEICNOTAFISC PLACAVEIC,'
      
        '       I.ID_INTEGRADO , F.NM_FORNECEDOR ||'#39' '#39'||  NG.DESC_NUCLEO ' +
        'NM_FORNECEDOR , NF.DT_SAIDNOTAFISC - A.DATA_ALOJAMENTO IDADE,'
      '       IR.QTD_AVESABAT, '
      '       IR.PESO_AVES LIQUIDO , '
      
        '       CASE WHEN IR.QTD_AVESABAT > 0 THEN ROUND(IR.PESO_AVES / I' +
        'R.QTD_AVESABAT,2) END PESO_MEDIO,'
      
        '       IR.TURMA  , T.NM_FORNECEDOR TURMEIRO, TO_NUMBER( P.GN_OBS' +
        'EPEDIVEND ) QTD_PREVISAO'
      ...
      ' AND IR.PESO_AVES > 0'
      'ORDER BY I.ID_INTEGRADO, NF.NR_NOTAFISC, NF.DT_SAIDNOTAFISC')
    FetchAll = True
    ...
    object QrQTD_AVESABAT: TFloatField
      FieldName = 'QTD_AVESABAT'
      DisplayFormat = '#,###'
    end
    object QrLIQUIDO: TFloatField
      FieldName = 'LIQUIDO'
      DisplayFormat = '#,###'
    end
    ...
    object QrTURMA: TIntegerField
      FieldName = 'TURMA'
    end
    object QrTURMEIRO: TStringField
      FieldName = 'TURMEIRO'
      Size = 40
    end
    object QrQTD_PREVISAO: TFloatField
      FieldName = 'QTD_PREVISAO'
      DisplayFormat = '#,###'
    end
    object QrDIF_QTDE: TFloatField
  ...
  object Qr_Turma: TOraQuery
    ...
    SQL.Strings = (
        ...
        'Select IR.TURMA , T.NM_FORNECEDOR TURMEIRO , SUM(IR.QTD_AVESABAT' +
        ') AVES  ,'
      'SUM(PESO_AVES) PESO_AVES'
      '  From INTEGRADO_RETIRADA IR'
      ' Inner Join INTEGRADO_ALOJAMENTO A'
      '    On IR.ID_LOTE = A.ID_LOTE'
      ' Inner Join INTEGRADO I '
      ...
      ' AND NF.DT_SAIDNOTAFISC <= :DataFim'
      ' AND IR.PESO_AVES > 0'
      'GROUP BY IR.TURMA , T.NM_FORNECEDOR'
      'ORDER BY  T.NM_FORNECEDOR')
    FetchAll = True
    Left = 776
    Top = 62
    ParamData = <
    ...
    object Qr_TurmaTURMEIRO: TStringField
      FieldName = 'TURMEIRO'
      Size = 40
    end
    object Qr_TurmaAVES: TFloatField
      FieldName = 'AVES'
      DisplayFormat = '#,###'
    end
    object Qr_TurmaPESO_AVES: TFloatField
      FieldName = 'PESO_AVES'
      DisplayFormat = '#,###'
    end
  end
  ...
  object Qr_Abatedouro: TOraQuery
    Session = FrmPrincipal.DB
    SQL.Strings = (
      'Select  C.NM_CLIENTE, '
      '       SUM(IR.QTD_AVESABAT) AVES,'
      '      SUM(PESO_AVES) PESO_AVES'
      '  From INTEGRADO_RETIRADA IR'
      ' Inner Join INTEGRADO_ALOJAMENTO A'
      '    On IR.ID_LOTE = A.ID_LOTE'
    ...
    object Qr_AbatedouroNM_CLIENTE: TStringField
      FieldName = 'NM_CLIENTE'
      Required = True
      Size = 40
    end
    object Qr_AbatedouroAVES: TFloatField
      FieldName = 'AVES'
      DisplayFormat = '#,###'
    end
    object Qr_AbatedouroPESO_AVES: TFloatField
      FieldName = 'PESO_AVES'
      DisplayFormat = '#,###'
    end
  end
  object Ds_Abatedouro: TOraDataSource
    DataSet = Qr_Abatedouro
    Left = 808
    Top = 95
  end
end
