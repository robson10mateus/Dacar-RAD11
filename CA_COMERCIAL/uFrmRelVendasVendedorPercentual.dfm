object frmRelVendasVendedorPercentual: TfrmRelVendasVendedorPercentual
  Left = 714
  Top = 474
  Width = 486
  Height = 212
  ...
  object Panel2: TPanel
    ...
    object CheckBox1: TCheckBox
      ...
      Width = 200
      Height = 31
      Caption = 'Descontar Devolu'#231#245'es'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = 15
      Font.Name = 'Arial'
  ...
  object qryMovimento: TOraQuery
    ...
    object qryMovimentoTT_VENDEDOR: TFloatField
      FieldName = 'TT_VENDEDOR'
      DisplayFormat = '#,##0.00'
    end
    object qryMovimentoTT_PERIODO: TFloatField
      FieldName = 'TT_PERIODO'
      DisplayFormat = '#,##0.00'
    end
    object qryMovimentoVL_PERCENT: TFloatField
      FieldName = 'VL_PERCENT'
      DisplayFormat = '#,##0.00'
    end
    object qryMovimentoTT_PESO: TFloatField
      FieldName = 'TT_PESO'
      DisplayFormat = '#,##0.000'
    end
    object qryMovimentoCO_VENDEDOR: TIntegerField
      FieldName = 'CO_VENDEDOR'
    end
    object qryMovimentoDT_EMISSAO: TDateTimeField
