...
uses
  ...
  Math, {JvMemoryDataset, JvCsvData,} DBCtrls, DateUtils;
...
type
  TfrmEmissorNFe = class(TForm)
    ...
    procedure QImpDocPedBeforeOpen(DataSet: TDataSet);
...
procedure TfrmEmissorNFe.QImpDocPedAfterScroll(DataSet: TDataSet);
begin
  HabilitaBotoes();
end;
...
procedure TfrmEmissorNFe.QImpDocPedBeforeOpen(DataSet: TDataSet);
begin
  if ( chkAmb.Checked ) then
