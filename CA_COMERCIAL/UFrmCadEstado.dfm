object FrmCadEstado: TFrmCadEstado
      ...
      object TabDetalhes: TTabSheet
        ...
        object Panel3: TPanel
          ...
          object Label7: TLabel
            ...
            Width = 125
            Height = 15
            Caption = 'Aliq. ICMS Contribuinte'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = 15
            Font.Name = 'Arial'
          ...
          object Label8: TLabel
            ...
            Width = 151
            Height = 15
            Caption = 'Aliq. ICMS N'#227'o Contribuinte'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = 15
            Font.Name = 'Arial'
          ...
          object DBAliq: TDBEdit
            Left = 24
            Top = 224
            Width = 89
            Height = 23
            DataField = 'PC_ICMSCONTESTA'
            DataSource = DtSrcCadEstado
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = 15
          ...
          object DBAliqN: TDBEdit
            Left = 192
            Top = 224
            Width = 89
            Height = 23
            DataField = 'PC_ICMSNAOCONTESTA'
            DataSource = DtSrcCadEstado
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = 15
          ...
          object DBReg: TDBLookupComboBox
            Left = 24
            Top = 176
            Width = 297
            Height = 23
            ...
            Font.Name = 'Arial'
            Font.Style = []
            KeyField = 'ID_REGIGEOG'
            ListField = 'NM_REGIGEOG'
            ListSource = DtSrcRegiaoGeog
            ParentFont = False
            TabOrder = 7
          end
  ...
  object QryRegiaoGeog: TOraQuery
    SQL.Strings = (
      ...
      ' pais'
      'where'
      '  pais.id_pais = regiao_geografica.id_pais and'
      '  regiao_geografica.id_pais= :id_pais'
      '')
    Left = 413
    Top = 208
    ParamData = <
    ...
    object QryRegiaoGeogID_REGIGEOG: TFloatField
      FieldName = 'ID_REGIGEOG'
      Required = True
    end
    object QryRegiaoGeogNM_REGIGEOG: TStringField
      FieldName = 'NM_REGIGEOG'
      Required = True
      Size = 30
    end
  end
  object DtSrcRegiaoGeog: TOraDataSource
    DataSet = QryRegiaoGeog
    Left = 464
    Top = 208
  end
