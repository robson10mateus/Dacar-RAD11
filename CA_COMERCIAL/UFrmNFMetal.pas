...
type
  TFrmNFMetal = class(TForm)
    ...
    qryNotaFiscDESCR_EMBALAGEM: TStringField;
    qryNotaFiscQN_PESOPEDIVEND: TFloatField;
    qryNotaFiscQN_EMBAPEDIVEND: TFloatField;
...
procedure TFrmNFMetal.RL_NotasBeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
