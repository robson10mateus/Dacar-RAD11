object FrmCorteProdutos: TFrmCorteProdutos
  Left = 31
  Top = 177
  ActiveControl = PageControl1
  Caption = 'Corte de Produtos'
  ClientHeight = 458
  ClientWidth = 925
  Color = clWindow
  ...
  object Qr: TOraQuery
    ...
    SQL.Strings = (
      'Select P.ID_PEDIVEND,'
      '       C.ID_CLIENTE, '
      '       C.NM_CLIENTE, '
      '       P.QN_CAIXCORTITEMPEDIVEND, '
      '       P.ID_MATEEMBA, '
      '       M.NM_PRODMATEEMBA,'
      '       V.ID_VENDEDOR,'
      '       V.NM_VENDEDOR,'
      '       P.VL_UNITITEMPEDIVEND, '
      '       P.QN_PESOITEMPEDIVEND,'
      '(P.QN_CAIXCORTITEMPEDIVEND * M.QN_CAPAMEDIMATEEMBA) AS PMEDIO'
      ''
      'From PEDIDO_VENDA_ITEM P'
      ''
      'Inner Join MATERIAL_EMBALAGEM M'
      'On M.ID_MATERIAL = P.ID_MATERIAL'
      'Inner Join PEDIDO_VENDA PV'
      'On PV.ID_PEDIVEND = P.ID_PEDIVEND'
      'Inner Join CLIENTE C'
      'On C.ID_CLIENTE = PV.ID_CLIENTE'
      'Inner Join VENDEDOR V'
      'On V.ID_VENDEDOR = PV.ID_VENDEDOR'
      ''
      '--Where (P.QN_CAIXCORTITEMPEDIVEND > 0)'
      ''
      ''
      '&Macro')
    FetchAll = True
