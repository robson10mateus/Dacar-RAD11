object FrmCadTransport: TFrmCadTransport
  ...
  object OQry_Forn: TOraQuery
    KeyFields = 'id_fornecedor'
    KeySequence = 'SMART.ID_FORNECEDOR'
    SQLInsert.Strings = (
    ...
    object OQry_FornNR_INSCPRODFORN: TStringField
      DisplayLabel = 'Inscri'#231#227'o Produtor Rural'
    ...
    object OQry_FornCOD_FUNC: TIntegerField
      DisplayLabel = 'Codigo Funcionario'
      FieldName = 'COD_FUNC'
    end
    ...
    object OQry_FornDT_ALTEFORN: TDateTimeField
      DisplayLabel = 'Data da Ultima Altera'#231#227'o'
  ...
  object QrVeiculos: TOraQuery
    ...
    MasterFields = 'ID_FORNECEDOR'
    CachedUpdates = True
    BeforePost = QrVeiculosBeforePost
    Left = 745
    Top = 57
    ParamData = <
      item
