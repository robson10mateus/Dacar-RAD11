object FrmResultGranjeiro: TFrmResultGranjeiro
  Left = 297
  Top = 113
  ActiveControl = PageControl1
  Caption = 'Resultado por Granjeiro'
  ClientHeight = 489
  ClientWidth = 1032
  Color = clWindow
    ...
    object Tab_Criterio: TTabSheet
      ...
      object Cmb_TipoData: TComboBox
        ...
        Items.Strings = (
          'Data Saida'
          'Data Encerramento'
          'Data Ultima Retirada'
          'Data Primeira Retirada')
      end
    end
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'AVES_ABAT'
            Title.Caption = 'Aves Abat'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'PER_PRIM_SEM'
            Title.Caption = 'Mort 1'#170' Sem'
            Visible = True
          end
          item
            Expanded = False
          ...
          item
            ...
            Title.Caption = 'Total Ra'#231#227'o'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'CONS_MEDIO'
            Title.Caption = 'Cons Medio Rac'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'CONV_ALIMENTAR'
            Title.Caption = 'Conv. Alimentar'
            Visible = True
          end
          item
            Expanded = False
          ...
          item
            Expanded = False
            FieldName = 'PRECO_AVE'
            Title.Caption = 'Pre'#231'o Ave'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'PRECO_AVE_FINAL'
            Title.Caption = 'Pre'#231'o Ave Final'
            Visible = True
          end
          item
            Expanded = False
          ...
          item
            Expanded = False
            FieldName = 'ULTIMA_RETIRADA'
            Title.Caption = 'Ult Retirada'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'PRIM_RETIRADA'
            Title.Caption = 'Prim Retirada'
            Visible = True
          end>
      end
    end
  ...
  object Qr: TOraQuery
    ...
    SQL.Strings = (
      ' Select A.ID_LOTE, '
        ...
        '        A.DATA_ALOJAMENTO + A.IDADE + 1 DATA_SAIDA , A.DATA_ALOJ' +
        'AMENTO + A.IDADE ,  '
      '                CASE WHEN NG.DESC_NUCLEO IS NOT NULL'
      '             THEN NG.DESC_NUCLEO'
      '             ELSE F.NM_FORNECEDOR END   Granjeiro, '
      '        A.AVES_ALOJ QTD_INICIAL ,'
      '        A.AVES_ABAT,'
      
        '        ROUND((A.MORT_PRIM_SEMANA / A.AVES_ALOJ) * 100,2) PER_PR' +
        'IM_SEM  ,'
      '        A.PER_MORTALIDADE,'
      '        A.TOT_KG PESO,'
      '        A.PESO_MEDIO,'
      '        A.IDADE,'
      '        A.TOTAL_RACAO,'
      '        ROUND(A.TOTAL_RACAO / A.AVES_ABAT, 3) CONS_MEDIO,'
      '        A.CONV_ALIMENTAR,'
      '        A.IEP,'
      '        A.GANHO_PESO_DIA,'
      '        A.PRECO_AVE,'
      ...
      '        G.AVE_M2,'
      '        G.TL,'
      '        SUBSTR(FP.NM_FORNECEDOR,1,4) ORIG,'
      '        SUBSTR(IL.DESC_LINHAGEM,1,7) LINHAGEM,'
      '       A.DT_FECHAMENTO,'
      '       IR.PRIM_RETIRADA,'
      '       IR.ULTIMA_RETIRADA   '
      ...
      '      On F.Id_Fornecedor = i.Id_Fornecedor    '
      '   Inner Join (  Select LG.ID_LOTE, '
      
        '                          ROUND(SUM(LG.QTDE) /  SUM(IG.AREA_GALP' +
        'AO),2) AVE_M2 ,'
      '                          MAX(LG.TIPO) TL'
      '                  From INTEGRADO_ALOJAMENTO_GALPAO LG '
      '                 Inner Join INTEGRADO_GALPAO IG'
      '                    On LG.ID_GALPAO =  IG.ID_GALPAO'
      '                 GROUP BY LG.ID_LOTE ) G'
      '      On G.ID_LOTE = A.ID_LOTE '
      
        '   Inner Join ( Select A.ID_LOTE, A.ID_FORNECEDOR , SUM(A.QUANTI' +
        'DADE) , '
      
        '                   ROW_NUMBER() OVER ( PARTITION BY A.ID_LOTE OR' +
        'DER BY  SUM(A.QUANTIDADE) DESC ) LIN'
      '              From Integrado_Alojamento_FORNEC A'
      '              GROUP BY  A.ID_LOTE,  A.ID_FORNECEDOR ) MF'
      '     ON MF.LIN = 1'
      '    AND MF.ID_LOTE =  A.ID_LOTE '
      '   Inner Join Fornecedor FP'
      '      On MF.Id_Fornecedor = FP.Id_Fornecedor    '
      
        'Inner Join ( Select A.ID_LOTE, A.ID_LINHAGEM , SUM(A.QUANTIDADE)' +
        ' , '
      
        '                    ROW_NUMBER() OVER ( PARTITION BY A.ID_LOTE O' +
        'RDER BY  SUM(A.QUANTIDADE) DESC ) LIN'
      '               From Integrado_Alojamento_FORNEC A'
      '              GROUP BY  A.ID_LOTE,  A.ID_LINHAGEM      ) ML'
      '      ON ML.LIN = 1'
      '     AND ML.ID_LOTE = A.ID_LOTE'
      'Inner Join ( '
      'Select IR.ID_LOTE, '
      '       MIN(NF.DT_SAIDNOTAFISC) PRIM_RETIRADA,'
      '       MAX(NF.DT_SAIDNOTAFISC) ULTIMA_RETIRADA'
      '  From INTEGRADO_RETIRADA IR'
      ' Inner Join NOTA_FISCAL NF '
      '   On IR.ID_NOTAFISC = NF.ID_NOTAFISC'
      ' WHERE  IR.QTD_AVESABAT > 0 '
      '  AND IR.PESO_AVES > 0 '
      'GROUP BY IR.ID_LOTE  ) IR'
      '     ON  IR.ID_LOTE = A.ID_LOTE'
      '  Inner Join   Integrado_Linhagem IL'
      '     On ML.ID_LINHAGEM = IL.ID_LINHAGEM'
      ' Left Join NUCLEO_GALPAO NG'
      '   On NG.ID_NUCLEO = A.ID_NUCLEO    '
      '  '
      '   WHERE A.FL_STATUS = '#39'FE'#39
      '  &MacroData'
      '  &Macro'
      ' '
      ''
    ...
    object QrDATA_SAIDA: TDateTimeField
      FieldName = 'DATA_SAIDA'
      DisplayFormat = 'DD/MM/YY'
    end
    object QrGRANJEIRO: TStringField
      FieldName = 'GRANJEIRO'
      Required = True
      Size = 40
    end
    object QrQTD_INICIAL: TFloatField
      FieldName = 'QTD_INICIAL'
      DisplayFormat = '0,###'
    end
    ...
    object QrPER_PRIM_SEM: TFloatField
      FieldName = 'PER_PRIM_SEM'
    end
    object QrPER_MORTALIDADE: TFloatField
      FieldName = 'PER_MORTALIDADE'
    end
    object QrPESO: TFloatField
      FieldName = 'PESO'
      DisplayFormat = '0,###'
    end
    ...
    object QrAVE_M2: TFloatField
      FieldName = 'AVE_M2'
    end
    object QrTL: TStringField
      FieldName = 'TL'
      Size = 2
    end
    object QrORIG: TStringField
      FieldName = 'ORIG'
      Size = 4
    end
    object QrLINHAGEM: TStringField
      FieldName = 'LINHAGEM'
      Size = 7
    end
    object QrCONS_MEDIO: TFloatField
      FieldName = 'CONS_MEDIO'
    end
    ...
    object QrPRIM_RETIRADA: TDateTimeField
      FieldName = 'PRIM_RETIRADA'
      DisplayFormat = 'DD/MM/YY'
    end
    object QrULTIMA_RETIRADA: TDateTimeField
      FieldName = 'ULTIMA_RETIRADA'
      DisplayFormat = 'DD/MM/YY'
    end
  end
