object FrmATRA: TFrmATRA
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 135
      Height = 15
      Caption = 'Valor T'#237'tulos em Aberto:'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = 15
      Font.Name = 'Arial'
  ...
  object QRVENC: TOraQuery
    Session = FrmPrincipal.DB
    SQL.Strings = (
      'SELECT DISTINCT'
      '  CA_TITUREC.RNUMEDOCU,'
      '  CA_TITUREC.RDATAVENC,'
      '  CA_TITUREC.RVALODOCU,'
      '  CA_TITUREC.RST_COBRA,'
      '  CA_TITUREC.RID_CONTA,'
      
        '  (Case when  ca_titurec.rcodisitu=6 then '#39'Cheque S/F'#39' Else '#39'Cta' +
        '. a Rec.'#39' end) AS Tipo,'
      '  CONTA.NM_CONTA'
      'FROM'
      '  PEDIDO_VENDA,'
      '  CA_TITUREC,'
      ...
      '  CONTA'
      'WHERE'
      '  PEDIDO_VENDA.ID_PEDIVEND = CA_TITUREC.RNUMEDOCU AND'
      
        '  PEDIDO_VENDA.ID_TIPOPEDIVEND = PEDIDO_VENDA_TIPO.ID_TIPOPEDIVE' +
        'ND AND'
      '  (CA_TITUREC.RST_COBRA <> '#39'Q'#39') AND'
      '  (CA_TITUREC.RID_CLIENTE = :ID_CLIENTE) AND'
      '  NVL(fl_consfinatipopedivend,'#39'S'#39') = '#39'S'#39' AND'
      '  CONTA.ID_CONTA = CA_TITUREC.RID_CONTA'
      'ORDER BY'
      '  CA_TITUREC.RDATAVENC,'
      '  CA_TITUREC.RNUMEDOCU')
    Left = 240
    ...
    object QRVENCRNUMEDOCU: TStringField
      FieldName = 'RNUMEDOCU'
      Size = 10
    end
    object QRVENCRDATAVENC: TDateTimeField
      FieldName = 'RDATAVENC'
    end
    object QRVENCRVALODOCU: TFloatField
      FieldName = 'RVALODOCU'
      currency = True
    end
    object QRVENCRST_COBRA: TStringField
      FieldName = 'RST_COBRA'
      Size = 1
    end
    object QRVENCRID_CONTA: TFloatField
      FieldName = 'RID_CONTA'
    end
    object QRVENCTIPO: TStringField
      FieldName = 'TIPO'
      FixedChar = True
      Size = 11
    end
    object QRVENCNM_CONTA: TStringField
      FieldName = 'NM_CONTA'
      Required = True
      Size = 40
    end
  end
  object DSVenc: TOraDataSource
    DataSet = QRVENC
    Left = 280
    Top = 24
  end
  object QRTOT: TOraQuery
    Session = FrmPrincipal.DB
    SQL.Strings = (
      'SELECT DISTINCT'
      '   Sum(rvalodocu) AS vlaberto'
      
        ' FROM Pedido_Venda,ca_titurec,pedido_venda_tipo                 ' +
        '                    '
      'WHERE Pedido_Venda.id_pedivend=ca_titurec.rnumedocu'
      
        '  AND Pedido_Venda.id_tipopedivend=pedido_venda_tipo.id_tipopedi' +
        'vend'
      '  AND (rid_cliente = :ID_CLIENTE)'
      '  AND NVL(fl_consfinatipopedivend,'#39'S'#39')='#39'S'#39
      '  AND (rst_cobra = '#39'A'#39')                           ')
    Left = 328
    Top = 24
    ParamData = <
      item
    ...
    object QRTOTVLABERTO: TFloatField
      FieldName = 'VLABERTO'
      currency = True
    end
  end
  object DSTOT: TOraDataSource
    DataSet = QRTOT
    Left = 368
    Top = 24
  end
