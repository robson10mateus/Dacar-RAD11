...
//    procedure QrVeiculosAfterPost(DataSet: TDataSet);
    procedure CRTemp_QrVeiculosBeforePost(DataSet: TDataSet);
...
//  FrmPrincipal.CadastrodeTransportadores1.Enabled:= True;
  FrmPrincipal.ACCadTipoTransportadores.Enabled := True;
  Action:=caFree;
end;
...
procedure TFrmCadTransport.CRTemp_QrVeiculosBeforePost(DataSet: TDataSet);
begin
