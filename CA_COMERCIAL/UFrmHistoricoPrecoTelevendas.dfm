object FrmHistoricoPrecoTelevendas: TFrmHistoricoPrecoTelevendas
  Left = 314
  Top = 124
  Width = 792
  Height = 532
  ...
  Caption = 'Hist'#243'rico de Pre'#231'os do Televendas'
  Color = clBackground
  ...
  object Qry_HistoricoPreco: TOraQuery
    KeyFields = 'ID_HistoricoPreco'
    KeySequence = 'SMART.ID_HistoricoPreco'
    SQLInsert.Strings = (
      'INSERT INTO Televendas_Historico_Preco'
      
        '  (EMPRESA, FILIAL, ID_HISTORICOPRECO, ID_PRODMATEEMBA, DT_ALTER' +
        'ACAOPRECO, VL_PRECOCUSTO)'
      'VALUES'
      
        '  (:EMPRESA, :FILIAL, :ID_HISTORICOPRECO, :ID_PRODMATEEMBA, :DT_' +
        'ALTERACAOPRECO, :VL_PRECOCUSTO)')
    SQLDelete.Strings = (
      'DELETE FROM Televendas_Historico_Preco'
      'WHERE'
      '  ID_HISTORICOPRECO = :ID_HISTORICOPRECO')
    SQLUpdate.Strings = (
      'UPDATE Televendas_Historico_Preco'
      'SET'
      '  EMPRESA = :EMPRESA,'
      '  FILIAL = :FILIAL,'
      '  ID_HISTORICOPRECO = :ID_HISTORICOPRECO,'
      '  ID_PRODMATEEMBA = :ID_PRODMATEEMBA,'
      '  DT_ALTERACAOPRECO = :DT_ALTERACAOPRECO,'
      '  VL_PRECOCUSTO = :VL_PRECOCUSTO'
      'WHERE'
      '  ID_HISTORICOPRECO = :OLD_ID_HISTORICOPRECO')
    SQLLock.Strings = (
      'SELECT * FROM Televendas_Historico_Preco'
      'WHERE'
      '  ID_HISTORICOPRECO = :ID_HISTORICOPRECO'
      'FOR UPDATE NOWAIT')
    SQLRefresh.Strings = (
      'WHERE'
      '  Join.ID_HISTORICOPRECO = :ID_HISTORICOPRECO')
    Session = FrmPrincipal.DB
    SQL.Strings = (
      'Select Televendas_Historico_Preco.Empresa,'
      '       Televendas_Historico_Preco.Filial,'
      '       Televendas_Historico_Preco.ID_HistoricoPreco,'
      '       Televendas_Historico_Preco.Id_ProdMateEmba,'
      '       Televendas_Historico_Preco.Dt_AlteracaoPreco,'
      '       Televendas_Historico_Preco.Vl_PrecoCusto,'
      '       Material_Embalagem.Nm_Prodmateemba'
      '  from Televendas_Historico_Preco'
      '  Join Material_Embalagem'
      
        '    On Televendas_Historico_Preco.id_prodmateemba = Material_Emb' +
        'alagem.Id_Prodmateemba')
    CachedUpdates = True
    Left = 316
    Top = 219
    object Qry_HistoricoPrecoEMPRESA: TStringField
      FieldName = 'EMPRESA'
      Required = True
      Size = 2
    end
    object Qry_HistoricoPrecoFILIAL: TIntegerField
      FieldName = 'FILIAL'
      Required = True
    end
    object Qry_HistoricoPrecoID_HISTORICOPRECO: TFloatField
      FieldName = 'ID_HISTORICOPRECO'
      Required = True
    end
    object Qry_HistoricoPrecoID_PRODMATEEMBA: TStringField
      FieldName = 'ID_PRODMATEEMBA'
      Required = True
      Size = 5
    end
    object Qry_HistoricoPrecoVL_PRECOCUSTO: TFloatField
      FieldName = 'VL_PRECOCUSTO'
      Required = True
      DisplayFormat = '##0.00'
    end
    object Qry_HistoricoPrecoNM_PRODMATEEMBA: TStringField
      FieldName = 'NM_PRODMATEEMBA'
      Size = 40
    end
    object Qry_HistoricoPrecoDT_ALTERACAOPRECO: TDateTimeField
      FieldName = 'DT_ALTERACAOPRECO'
      Required = True
    end
  end
  object Dsc_HistoricoPreco: TDataSource
    DataSet = Qry_HistoricoPreco
    Left = 316
    Top = 267
  end
  ...
  object Qry_ChecaExite: TOraQuery
    Session = FrmPrincipal.DB
    SQL.Strings = (
      'Select ID_HISTORICOPRECO'
      '  From Televendas_Historico_Preco'
      ' Where Empresa           = :Empresa'
      '   And Filial            = :Filial'
      '   And Id_ProdMateEmba   = :Id_ProdMateEmba'
      '   And DT_AlteracaoPreco = :DT_AlteracaoPreco')
    Left = 420
    Top = 267
    ParamData = <
      item
      ...
      item
        DataType = ftDateTime
        Name = 'DT_AlteracaoPreco'
        ParamType = ptInput
        Value = nil
      end>
    object Qry_ChecaExiteID_HISTORICOPRECO: TFloatField
      FieldName = 'ID_HISTORICOPRECO'
      Required = True
    end
  end
