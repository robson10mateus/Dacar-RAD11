inherited frmPesquisaCargas: TfrmPesquisaCargas
  ...
  inherited DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'DT_CARGA'
        Title.Caption = 'Dt. Pesagem'
        Width = 80
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'QT_KGLIQUIDO'
        Title.Alignment = taRightJustify
        Title.Caption = 'Kg Expedido'
        Width = 100
        Visible = True
      end
      item
  ...
  object qryCarga: TOraQuery
    ...
    SQL.Strings = (
      'SELECT CG.ID_CARGEXPE AS NUM_CARGA, CG.DT_CARGEXPE AS DT_CARGA, '
      '    CG.DT_MONTCARGEXPE, CG.DT_ABERCARGEXPE,  CG.DT_FECHCARGEXPE,'
      '    (CASE WHEN CG.FL_STATCARGEXPE = '#39'FE'#39' THEN '#39'FECHADA'#39
      '    WHEN CG.FL_STATCARGEXPE = '#39'NF'#39' THEN '#39'PNF'#39
      '    WHEN CG.FL_STATCARGEXPE = '#39'BQ'#39' THEN '#39'BLOQUEADA'#39
      
        '    WHEN CG.FL_STATCARGEXPE = '#39'MT'#39' THEN '#39'EM MONTAGEM'#39' END) AS OP' +
        '_STATUS,    '
      
        '    (SUBSTR(CG.GN_PLACVEICTRAN,1,3)|| '#39' - '#39' || SUBSTR(CG.GN_PLAC' +
        'VEICTRAN,4,4)) AS NO_PLACAVEICULO, F.NM_FORNECEDOR AS NO_TRANSPO' +
        'RTADOR,'
      '  Sum(Nvl(PV.qn_pesorealexpepedivend,0)) AS QT_KGlIQUIDO,'
      '  Sum(Nvl(PV.qn_embaexpepedivend,0)) AS QT_CAIXA'
      'FROM  '
      '    EXPEDICAO_CARGA CG'
      'JOIN PEDIDO_VENDA PV ON(PV.ID_CARGEXPE = CG.ID_CARGEXPE)'
      'JOIN FORNECEDOR F ON(F.ID_FORNECEDOR = CG.ID_ITEMPROGCAMI)'
      'GROUP BY'
      
        '    CG.ID_CARGEXPE, CG.DT_CARGEXPE, CG.DT_MONTCARGEXPE, CG.DT_AB' +
        'ERCARGEXPE, CG.DT_FECHCARGEXPE, CG.FL_STATCARGEXPE, CG.GN_PLACVE' +
        'ICTRAN, F.NM_FORNECEDOR'
      'ORDER BY'
      '    CG.ID_CARGEXPE')
    Left = 168
    Top = 8
    object qryCargaNUM_CARGA: TFloatField
      FieldName = 'NUM_CARGA'
      Required = True
    end
    object qryCargaDT_CARGA: TDateTimeField
      FieldName = 'DT_CARGA'
      Required = True
    ...
    object qryCargaOP_STATUS: TStringField
      FieldName = 'OP_STATUS'
      Size = 11
    end
    object qryCargaNO_PLACAVEICULO: TStringField
      FieldName = 'NO_PLACAVEICULO'
      Size = 10
    end
    object qryCargaNO_TRANSPORTADOR: TStringField
      FieldName = 'NO_TRANSPORTADOR'
      Required = True
      Size = 40
    end
    object qryCargaQT_KGLIQUIDO: TFloatField
      FieldName = 'QT_KGLIQUIDO'
      DisplayFormat = '#########,###0.000'
    end
    object qryCargaQT_CAIXA: TFloatField
      FieldName = 'QT_CAIXA'
    end
  end
