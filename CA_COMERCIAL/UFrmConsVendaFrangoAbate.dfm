object FrmConsVendaFrangoAbate: TFrmConsVendaFrangoAbate
  Left = 376
  Top = 89
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'PESO_NF'
            Title.Caption = 'Peso NF'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'VL_UNIT_NF'
            Title.Caption = 'Vl Unit NF'
            Visible = True
          end
          item
            Expanded = False
  ...
  object Qr: TOraQuery
    ...
    SQL.Strings = (
      'Select C.NM_CLIENTE,NF.DT_SAIDNOTAFISC, '
      '        NF.GN_PLACVEICNOTAFISC PLACAVEIC,'
      
        '        I.ID_INTEGRADO , F.NM_FORNECEDOR  ||'#39' '#39'|| NG.DESC_NUCLEO' +
        '  NM_FORNECEDOR,'
      '        P.ID_PEDIVEND, NF.NR_NOTAFISC,'
      '        NI.QN_PESOITEMNOTAFISC PESO_NF ,'
      '        NI.VL_UNITITEMNOTAFISC VL_UNIT_NF,'
      '        NI.VL_ITEMNOTAFISC VL_ITEMNF,'
      '        IR.QTD_AVESABAT QTD_REAL,'
      '        IR.PESO_AVES PESO_REAL, '
      '        IR.VL_UNIT,'
      
        '       CASE WHEN IR.QTD_AVESABAT > 0 THEN ROUND(IR.PESO_AVES / I' +
        'R.QTD_AVESABAT,2) END PESO_MEDIO               '
      ...
      '     On NF.ID_NOTAFISC = NI.ID_NOTAFISC    '
      ...
      ''
      'Where NF.DT_SAIDNOTAFISC >= :DataIni'
      ' AND NF.DT_SAIDNOTAFISC <= :DataFim'
      'AND NVL(IR.PESO_AVES,0) > 0 '
      'ORDER BY C.NM_CLIENTE , I.ID_INTEGRADO , NF.DT_SAIDNOTAFISC')
    FetchAll = True
    OnCalcFields = QrCalcFields
    Left = 72
    Top = 152
    ParamData = <
      item
    ...
    object QrPLACAVEIC: TStringField
      FieldName = 'PLACAVEIC'
      Size = 10
    end
    ...
    object QrPESO_NF: TFloatField
      FieldName = 'PESO_NF'
      Required = True
      DisplayFormat = '0,000'
    end
    object QrVL_UNIT_NF: TFloatField
      FieldName = 'VL_UNIT_NF'
      Required = True
      DisplayFormat = '#,##0.00'
    end
    object QrVL_ITEMNF: TFloatField
      FieldName = 'VL_ITEMNF'
      Required = True
      DisplayFormat = '0,000.00'
    end
    object QrQTD_REAL: TFloatField
      FieldName = 'QTD_REAL'
      DisplayFormat = '0,000'
    end
    object QrPESO_REAL: TFloatField
      FieldName = 'PESO_REAL'
      DisplayFormat = '0,000'
    end
    ...
    object QrDIF_PESO: TFloatField
      FieldKind = fkCalculated
      FieldName = 'DIF_PESO'
      DisplayFormat = '0,000'
      Calculated = True
    end
    object QrVL_PESOREAL: TFloatField
      FieldKind = fkCalculated
      FieldName = 'VL_PESOREAL'
      DisplayFormat = '#,##0.00'
      Calculated = True
    end
  end
  ...
  object Qr_Resumo: TOraQuery
    ...
    SQL.Strings = (
      'Select C.NM_CLIENTE ,'
        ...
        '        I.ID_INTEGRADO , F.NM_FORNECEDOR ||'#39' '#39'|| NG.DESC_NUCLEO ' +
        ' NM_FORNECEDOR ,'
      '        SUM(IR.QTD_AVESABAT) QTD_REAL,'
      '        SUM(IR.PESO_AVES) PESO_REAL, '
      '        AVG(IR.VL_UNIT) VL_UNIT,        '
      '        SUM(IR.PESO_AVES * IR.VL_UNIT ) VL_Total,'
      
        '       AVG(CASE WHEN IR.QTD_AVESABAT > 0 THEN ROUND(IR.PESO_AVES' +
        ' / IR.QTD_AVESABAT,2) END )PESO_MEDIO               '
      '  From INTEGRADO_RETIRADA IR'
      ' Inner Join INTEGRADO_ALOJAMENTO A'
      '    On IR.ID_LOTE = A.ID_LOTE'
      ' Inner Join INTEGRADO I '
      ...
      ' AND NF.DT_SAIDNOTAFISC <= :DataFim'
        ...
        'GROUP BY C.NM_CLIENTE, I.ID_INTEGRADO , F.NM_FORNECEDOR,NG.DESC_' +
        'NUCLEO '
      'ORDER BY C.NM_CLIENTE , I.ID_INTEGRADO')
    FetchAll = True
    OnCalcFields = QrCalcFields
    Left = 72
    Top = 184
    ...
    object Qr_ResumoNM_CLIENTE: TStringField
      FieldName = 'NM_CLIENTE'
      Required = True
      Size = 40
    end
    object Qr_ResumoID_INTEGRADO: TFloatField
      FieldName = 'ID_INTEGRADO'
      Required = True
    end
    object Qr_ResumoNM_FORNECEDOR: TStringField
      FieldName = 'NM_FORNECEDOR'
      Required = True
      Size = 40
    end
    object Qr_ResumoQTD_REAL: TFloatField
      FieldName = 'QTD_REAL'
      DisplayFormat = '#,##0'
    end
    object Qr_ResumoPESO_REAL: TFloatField
      FieldName = 'PESO_REAL'
      DisplayFormat = '#,##0'
    end
    object Qr_ResumoVL_UNIT: TFloatField
      FieldName = 'VL_UNIT'
      DisplayFormat = '#,##0.00'
    end
    object Qr_ResumoPESO_MEDIO: TFloatField
      FieldName = 'PESO_MEDIO'
      DisplayFormat = '#,##0.000'
    end
    object Qr_ResumoVL_TOTAL: TFloatField
      FieldName = 'VL_TOTAL'
      DisplayFormat = '#,##0.00'
    end
  end
  object Ds_Resumo: TOraDataSource
    DataSet = Qr_Resumo
    Left = 104
    Top = 185
  end
