object FrmRelVendasDiaria: TFrmRelVendasDiaria
  Left = 434
  Top = 214
  Width = 1028
  Height = 675
  ...
  PixelsPerInch = 96
  TextHeight = 15
  object rptVendasDiaria: TRLReport
    Left = 0
    Top = 15
    Width = 794
    Height = 1123
    DataSource = frmVendasDiaria.dtsVendaDiaria
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clBlack
    Font.Height = 11
    Font.Name = 'Arial'
    ...
    object Cabecalho_02: TRLBand
      ...
      object lblQtdeProduto: TRLLabel
        Left = 319
        Top = 0
        Width = 42
        Height = 16
      ...
      object lblValorUnitProduto: TRLLabel
        Left = 364
        Top = 0
        Width = 75
        Height = 16
    ...
    object grpProduto: TRLGroup
      Left = 42
      Top = 146
      Width = 710
      Height = 71
      DataFields = 'ID_MATEEMBA'
      object CabecGrupoProduto: TRLBand
        Left = 0
        Top = 0
        Width = 710
        Height = 28
        ...
        object dbDescProduto: TRLDBText
          Left = 112
          Top = 5
          Width = 592
          Height = 18
      ...
      object Detalhes: TRLBand
        ...
        object dbNomeCliente: TRLDBText
          Left = 93
          Top = 0
          Width = 217
          Height = 14
        ...
        object dbValorUnitProduto: TRLDBText
          Left = 363
          Top = 0
          Width = 75
          Height = 14
    ...
    object Cabecalho: TRLBand
      ...
      object lblSubTitulo: TRLLabel
        ...
        Alignment = taCenter
        AutoSize = False
        Caption = 'Relat'#243'rio de Vendas Di'#225'ria'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = 15
        Font.Name = 'Arial'
