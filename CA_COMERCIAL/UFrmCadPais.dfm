object FrmCadPais: TFrmCadPais
    ...
    object TabDetalhes: TTabSheet
      ...
      object Panel3: TPanel
        ...
        object Label6: TLabel
          ...
          Width = 114
          Height = 15
          Caption = 'Regi'#227'o Internacional'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = 15
          Font.Name = 'Arial'
        ...
        object DBRegObrig: TDBRadioGroup
          Left = 27
          Top = 158
          Width = 110
          Height = 50
          Caption = 'Regi'#227'o Obrigatoria'
          DataField = 'FL_REGIOBRIPAIS'
          DataSource = DtSrcCadPais
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = 15
        ...
        object DBRegInt: TDBLookupComboBox
          Left = 24
          Top = 128
          Width = 297
          Height = 23
          ...
          Font.Pitch = fpVariable
          Font.Style = []
          KeyField = 'ID_REGIINTE'
          ListField = 'NM_REGIINTE'
          ListSource = DtSrcRegInt
          ParentFont = False
          TabOrder = 3
        end
  ...
  object QryRegInt: TOraQuery
    ...
    Left = 534
    Top = 11
    object QryRegIntID_REGIINTE: TFloatField
      FieldName = 'ID_REGIINTE'
      Required = True
    end
    object QryRegIntNM_REGIINTE: TStringField
      FieldName = 'NM_REGIINTE'
      Required = True
      Size = 30
    end
  end
  object DtSrcRegInt: TOraDataSource
    DataSet = QryRegInt
    Left = 561
    Top = 11
  end
