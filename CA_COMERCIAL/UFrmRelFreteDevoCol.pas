...
type
  TFrmRelFreteDevoCol = class(TForm)
    RLReport1: TRLReport;
    QrFrete: TOraQuery;
    RLBand1: TRLBand;
    RLLabel1: TRLLabel;
...
//    PDSetup: TRLPrintDialogSetup;
    ...
    QrFreteCOD_FRETEPG: TStringField;
    RLDBpedivend: TRLDBText;
...
var
  FrmRelFreteDevoCol: TFrmRelFreteDevoCol;

implementation

{$R *.dfm}

procedure TFrmRelFreteDevoCol.RLBand7BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  //SUBTOTAIS
...
procedure TFrmRelFreteDevoCol.RLBand5BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TFrmRelFreteDevoCol.RLBand4BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
