object FrmTituAtra: TFrmTituAtra
  Left = 270
  Top = 46
  Width = 496
  Height = 473
  ...
  Caption = 'T'#237'tulos em Atrazo e a Vencer'
  Color = clBackground
  ...
  object QRVENC: TOraQuery
    ...
    SQL.Strings = (
      ...
      '        rid_conta,'
        ...
        '       (Case when rcodisitu=6 then '#39'Cheque S/F'#39' Else '#39'Cta. a Rec' +
        '.'#39' end) as Tipo  '
      '  FROM  ca_titurec                                     '
      ' WHERE (rst_cobra <> '#39'Q'#39')                           '
