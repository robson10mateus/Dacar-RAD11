object FrmCadVendedor: TFrmCadVendedor
  ...
  object PageControl: TPageControl
    ...
    object TabCriterio: TTabSheet
      ...
      object LCampos: TListBox
        ...
        Items.Strings = (
          ...
          'Ativo'
          'Comissionado'
          'Pessoa F'#237'sica/ Juridica'
          'CNPJ'
          'Inscri'#231#227'o Estadual'
          'RG'
          'CPF'
          'Comiss'#227'o'
          'Participa'#231#227'o no Corte'
          'Fornecedor')
        ParentFont = False
    ...
    object TabDetalhes: TTabSheet
      ...
      object Panel3: TPanel
        ...
        object DBNumeroLogradouro: TDBEdit
          Left = 450
          Top = 200
          Width = 68
          Height = 23
          DataField = 'NR_LOGRVEND'
          DataSource = DtSrcVendedor
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = 15
        ...
        object dbchkBloqueio: TDBCheckBox
          ...
          DataField = 'FL_BLOQADMIVEND'
          DataSource = DtSrcVendedor
          TabOrder = 23
          ValueChecked = 'S'
          ValueUnchecked = 'N'
        end
        object dbchkComissionado: TDBCheckBox
          Left = 180
          Top = 15
          Width = 110
          Height = 17
          Caption = 'Comissionado'
          DataField = 'FL_COMIVEND'
          DataSource = DtSrcVendedor
          TabOrder = 21
          ValueChecked = 'S'
          ValueUnchecked = 'N'
          OnClick = dbchkComissionadoClick
        end
        ...
        object BtnDataNascimento: TBitBtn
          ...
          ParentFont = False
          TabOrder = 16
          OnClick = BtnDataNascimentoClick
        end
        ...
        object dbchkCorte: TDBCheckBox
          Left = 180
          Top = 40
          Width = 130
          Height = 17
          Caption = 'Participa no Corte'
          DataField = 'FL_PARTCORTE'
          DataSource = DtSrcVendedor
          TabOrder = 22
          ValueChecked = 'S'
          ValueUnchecked = 'N'
        ...
        object dblkcbbTIpoLogradouro: TDBLookupComboBox
          Left = 10
          Top = 200
          Width = 100
          Height = 23
          ...
          ListSource = DtSrcTipoLogradouro
          ParentFont = False
          TabOrder = 4
        end
        object dblkcbbTipoVendedor: TDBLookupComboBox
          ...
          Font.Pitch = fpVariable
          Font.Style = []
          KeyField = 'ID_TIPOVENDEDOR'
          ListField = 'NM_TIPOVENDEDOR'
          ListSource = DtSrcTipoVendedor
          ParentFont = False
          TabOrder = 3
        end
        ...
        object GroupBox1: TGroupBox
          ...
          object DBOrgaoExpedidor: TDBEdit
            Left = 230
            Top = 25
            Width = 70
            Height = 23
            DataField = 'GN_ORGAEXPERGVEND'
            DataSource = DtSrcVendedor
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlack
            Font.Height = 15
  ...
  object DtSrcDireitos: TOraDataSource
    Left = 892
    Top = 8
  end
  object qryClientes: TOraQuery
    ...
    SQL.Strings = (
        ...
        'SELECT nm_cliente FROM cliente WHERE id_cliente = :id_Cliente or' +
        'der by nm_cliente'
      ' ')
    Left = 804
    Top = 9
  ...
  object DtSrcClientes: TOraDataSource
    DataSet = qryClientes
    Left = 832
    Top = 9
  end
  object qryTipoLogradouro: TOraQuery
    Session = FrmPrincipal.DB
    SQL.Strings = (
      'SELECT '
  ...
  object DtSrcTipoLogradouro: TOraDataSource
    DataSet = qryTipoLogradouro
    Left = 721
    Top = 8
  end
  object qryTipoVendedor: TOraQuery
    Session = FrmPrincipal.DB
    SQL.Strings = (
      
        'select id_tipovendedor, nm_tipovendedor from vendedor_tipo order' +
        ' by nm_tipovendedor')
    Left = 749
    Top = 9
  end
  object DtSrcTipoVendedor: TOraDataSource
    DataSet = qryTipoVendedor
    Left = 776
    Top = 9
  end
  object qryCidade: TOraQuery
    Session = FrmPrincipal.DB
    SQL.Strings = (
      'SELECT id_cidade, nm_cidade FROM cidade order by nm_cidade')
    Left = 527
    Top = 9
  end
  ...
  object qryFornecedor: TOraQuery
    Session = FrmPrincipal.DB
    SQL.Strings = (
      
        'SELECT id_fornecedor, nm_fornecedor FROM fornecedor order by nm_' +
        'fornecedor')
    Left = 583
    Top = 7
  end
  object DtSrcFornecedor: TOraDataSource
  ...
  object qryUsuario: TOraQuery
    ...
    SQL.Strings = (
        ...
        'select t.id_usuario, t.nome_usuario from sct_usuario t order by ' +
        't.nome_usuario')
    Left = 638
    Top = 10
