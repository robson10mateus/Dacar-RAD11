object FrmItemCarLibCar: TFrmItemCarLibCar
  Left = 541
  Top = 316
  Width = 1189
  Height = 487
  ...
  Caption = 'Comercial Dacar - Pedidos da Carga N'#186' '
  Color = clBackground
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'ID.SUBR.LOGI.'
            Visible = False
          end
          item
            Expanded = False
            FieldName = 'NM_SUBRLOGI'
            Title.Caption = 'NOME SUBR.'
            Visible = False
          end
          item
            Expanded = False
  ...
  object qryForm: TOraQuery
    ...
    SQL.Strings = (
      ...
      '       Pedido_venda.QN_TARAPEDIVEND,'
        ...
        '      (Pedido_venda.QN_PESOPEDIVEND + Pedido_venda.QN_TARAPEDIVE' +
        'ND) QN_PESOBRUTPEDIVEND,'
      ...
      '   AND (Cliente.ID_SUBRLOGI = Logistica_subregiao.ID_SUBRLOGI)'
        ...
        '   AND (Logistica_regiao.ID_REGILOGI = Logistica_regiao_subregia' +
        'o.ID_REGILOGI)'
      
        '   AND (Logistica_subregiao.ID_SUBRLOGI = Logistica_regiao_subre' +
        'giao.ID_SUBRLOGI)'
      '   AND (Pedido_venda.ID_CARGEXPE = :pi_NumeCarg)')
    Left = 216
    Top = 8
    ParamData = <
      item
    ...
    object qryFormDT_ENTRPEDIVEND: TDateTimeField
      FieldName = 'DT_ENTRPEDIVEND'
      Required = True
    end
    ...
    object qryFormQN_PESOPEDIVEND: TFloatField
      FieldName = 'QN_PESOPEDIVEND'
    end
    object qryFormQN_TARAPEDIVEND: TFloatField
      FieldName = 'QN_TARAPEDIVEND'
    end
    object qryFormQN_PESOBRUTPEDIVEND: TFloatField
      FieldName = 'QN_PESOBRUTPEDIVEND'
    end
    object qryFormQN_EMBAPEDIVEND: TIntegerField
      FieldName = 'QN_EMBAPEDIVEND'
    end
    object qryFormQN_FATOFRETABAT_PEDIVEND: TFloatField
    ...
    object qryFormID_VENDEDOR: TFloatField
      FieldName = 'ID_VENDEDOR'
      Required = True
    end
    object qryFormDT_FATUPEDIVEND: TDateTimeField
      FieldName = 'DT_FATUPEDIVEND'
    end
    object qryFormNM_VENDEDOR: TStringField
      FieldName = 'NM_VENDEDOR'
      Required = True
      Size = 40
    end
    ...
    object qryFormNM_REDUCLIE: TStringField
      FieldName = 'NM_REDUCLIE'
      Required = True
      Size = 15
    end
    object qryFormQN_DIFIENTRCLIE: TIntegerField
      FieldName = 'QN_DIFIENTRCLIE'
    end
    object qryFormID_REGILOGI: TFloatField
      FieldName = 'ID_REGILOGI'
      Required = True
    end
    object qryFormID_SUBRLOGI: TFloatField
      FieldName = 'ID_SUBRLOGI'
      Required = True
    end
    object qryFormNM_REGILOGI: TStringField
      FieldName = 'NM_REGILOGI'
      Required = True
      Size = 40
    end
    object qryFormNM_SUBRLOGI: TStringField
      FieldName = 'NM_SUBRLOGI'
      Required = True
      Size = 40
    end
    object qryFormFL_RELAREGISUBRLOGI: TStringField
      FieldName = 'FL_RELAREGISUBRLOGI'
      Required = True
      Size = 1
    end
    object qryFormNR_ORDEPEDIVEND: TFloatField
    ...
    object qryFormFL_STATPEDIVEND: TStringField
      FieldName = 'FL_STATPEDIVEND'
      Required = True
      Size = 2
    end
    object qryFormNM_BAIRRO: TStringField
      FieldName = 'NM_BAIRRO'
      Required = True
      Size = 30
    end
    object qryFormNR_CEPENDECLIE: TStringField
      FieldName = 'NR_CEPENDECLIE'
      Required = True
      Size = 8
    end
    object qryFormNM_CIDADE: TStringField
      FieldName = 'NM_CIDADE'
      Required = True
      Size = 40
    end
    object qryFormSG_ESTADO: TStringField
      FieldName = 'SG_ESTADO'
      Required = True
      Size = 10
    end
