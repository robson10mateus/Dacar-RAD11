object FrmRelSaidaCarga: TFrmRelSaidaCarga
  Left = 755
  Top = 176
  Width = 927
  Height = 887
  ...
  object RLReport1: TRLReport
    ...
    object RLGroup1: TRLGroup
      ...
      object RLBand2: TRLBand
        ...
        object RLLabel1: TRLLabel
          ...
          Width = 190
          Height = 18
          Caption = 'Data/ Hora da Autoriza'#231#227'o:'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = 15
          Font.Name = 'Arial'
        ...
        object lblDDataHora_Autorizacao: TRLLabel
          Left = 510
          Top = 10
          Width = 180
          Height = 18
    ...
    object RLBand4: TRLBand
      ...
      object lbltitulo: TRLLabel
        ...
        Alignment = taCenter
        AutoSize = False
        Caption = 'AUTORIZA'#199#195'O DE SA'#205'DA DE VE'#205'CULOS'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = 16
        Font.Name = 'Arial'
    ...
    object Assinaturas: TRLBand
      ...
      Borders.FixedTop = True
      object lblAssMotorista: TRLLabel
        Left = 50
        Top = 65
        Width = 300
        Height = 20
      ...
      object lblAssAutorizante: TRLLabel
        Left = 368
        Top = 65
        Width = 300
        Height = 20
  ...
  object QrSAIDACARGA: TOraQuery
    SQL.Strings = (
      ...
      '          '
      '             ORDER BY PEDIDO_VENDA.NR_ORDEPEDIVEND')
    Left = 8
    Top = 8
    ParamData = <
      item
    ...
    object QrSAIDACARGAID_CIDADE: TFloatField
      FieldName = 'ID_CIDADE'
      Required = True
    end
  end
