object FrmRelFreteDevoCol: TFrmRelFreteDevoCol
  Left = 119
  Top = 154
  Width = 792
  Height = 543
  ...
  Caption = 'Relat'#243'rio de Frete Devolu'#231#227'o por Colaborador'
  Color = clBackground
  ...
  object RLReport1: TRLReport
    ...
    object RLBand1: TRLBand
      ...
      object lbltitulo: TRLLabel
        ...
        Width = 349
        Height = 18
        Caption = 'Confer'#234'ncia de Frete Devolu'#231#227'o por Colaborador'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = 16
        Font.Name = 'Arial'
  ...
  object QrFrete: TOraQuery
    ...
    object QrFreteCOD_FRETEPG: TStringField
      FieldName = 'COD_FRETEPG'
      Size = 15
    end
  end
