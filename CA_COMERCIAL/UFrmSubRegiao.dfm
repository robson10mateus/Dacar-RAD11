object FrmSubRegiao: TFrmSubRegiao
  Left = 294
  Top = 52
  Width = 800
  Height = 540
  ...
  object PageControl1: TPageControl
    ...
    object TabDetalhe: TTabSheet
      ...
      object DBNm_SubRegiao: TDBEdit
        ...
        ParentFont = False
        TabOrder = 1
        OnKeyPress = DBNm_SubRegiaoKeyPress
      end
      object DBFatorFrete: TDBEdit
        Left = 414
        Top = 31
        Width = 114
        Height = 23
        DataField = 'QN_FATOFRETABATSUBRLOGI'
        DataSource = DS
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = 15
      ...
      object Panel3: TPanel
        ...
        object DBNomeRodo: TDBEdit
          Left = 93
          Top = 21
          Width = 253
          Height = 23
          DataField = 'NM_RODOVIA'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = 15
          Font.Name = 'helvetica'
        ...
        object DBVlEixo: TDBEdit
          Left = 413
          Top = 21
          Width = 68
          Height = 23
          DataField = 'VALOR_EIXO'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = 15
          Font.Name = 'helvetica'
  ...
  object ToolBar1: TToolBar
    ...
    object SB_PRINT: TSpeedButton
      ...
      Glyph.Data = {
        ...
        00FFF07777777777780FF07777777777780FF00000000000000F000000000000
        000F077777777777707007777777777770800777777777777080077777777777
        708007777777777770800770000000000770F000FFFFFFF00000FFF0FCCCCCF0
  ...
  object Qr: TOraQuery
    ...
    object QrID_SUBRLOGI: TFloatField
      AutoGenerateValue = arAutoInc
      DisplayLabel = 'COD.'
      FieldName = 'ID_SUBRLOGI'
      Required = True
    end
    object QrNM_SUBRLOGI: TStringField
      DisplayLabel = 'NOME SUB-REGI'#195'O'
      FieldName = 'NM_SUBRLOGI'
      Required = True
      Size = 40
    end
    object QrFX_SUBRLOGI: TStringField
      FieldName = 'FX_SUBRLOGI'
      Required = True
      Size = 1
    end
    object QrID_INTESUBRLOGI: TStringField
      FieldName = 'ID_INTESUBRLOGI'
      Size = 10
    end
    object QrQN_FATOFRETABATSUBRLOGI: TFloatField
  ...
  object QrPedagio: TOraQuery
    KeyFields = 'ID_PEDAGIO'
    KeySequence = 'SEQCA_PEDAGIO'
    SQLInsert.Strings = (
      'INSERT INTO CA_PEDAGIO'
      
        '  (EMPRESA, FILIAL, ID_PEDAGIO, NM_RODOVIA, KM_PEDAGIO, ID_CIDAD' +
        'E, VALOR_EIXO)'
      'VALUES'
      
        '  (:EMPRESA, :FILIAL, :ID_PEDAGIO, :NM_RODOVIA, :KM_PEDAGIO, :ID' +
        '_CIDADE, :VALOR_EIXO)')
    SQLDelete.Strings = (
      'DELETE FROM CA_PEDAGIO'
      'WHERE'
      '  ID_PEDAGIO = :ID_PEDAGIO')
    SQLUpdate.Strings = (
      'UPDATE CA_PEDAGIO'
      'SET'
      '  EMPRESA = :EMPRESA,'
      '  FILIAL = :FILIAL,'
      '  ID_PEDAGIO = :ID_PEDAGIO,'
      '  NM_RODOVIA = :NM_RODOVIA,'
      '  KM_PEDAGIO = :KM_PEDAGIO,'
      '  ID_CIDADE = :ID_CIDADE,'
      '  VALOR_EIXO = :VALOR_EIXO'
      'WHERE'
      '  ID_PEDAGIO = :OLD_ID_PEDAGIO')
    SQLLock.Strings = (
      'SELECT * FROM CA_PEDAGIO'
      'WHERE'
      '  ID_PEDAGIO = :ID_PEDAGIO'
      'FOR UPDATE NOWAIT')
    SQLRefresh.Strings = (
    ...
    SQL.Strings = (
      ...
      'WHERE'
      '  (CIDADE.ID_CIDADE = CA_PEDAGIO.ID_CIDADE) AND'
      '  CA_PEDAGIO_SUBREGIAO.ID_PEDAGIO = CA_PEDAGIO.ID_PEDAGIO AND'
      '  CA_PEDAGIO_SUBREGIAO.ID_SUBRLOGI = :VID_SUBRLOGI')
    CachedUpdates = True
    Left = 528
    Top = 16
    ParamData = <
    ...
    object QrPedagioEMPRESA: TStringField
      FieldName = 'EMPRESA'
      Size = 2
    end
    object QrPedagioFILIAL: TIntegerField
      FieldName = 'FILIAL'
    end
    object QrPedagioID_PEDAGIO: TFloatField
      AutoGenerateValue = arAutoInc
      DisplayLabel = 'COD. PEDAGIO'
      FieldName = 'ID_PEDAGIO'
    end
    object QrPedagioNM_RODOVIA: TStringField
      DisplayLabel = 'NOME RODOVIA'
      FieldName = 'NM_RODOVIA'
      Size = 30
    end
    object QrPedagioKM_PEDAGIO: TFloatField
      DisplayLabel = 'KM'
      FieldName = 'KM_PEDAGIO'
    end
    object QrPedagioID_CIDADE: TFloatField
      DisplayLabel = 'COD. CIDADE'
      FieldName = 'ID_CIDADE'
    end
    object QrPedagioVALOR_EIXO: TFloatField
      DisplayLabel = 'VALOR EIXO'
      FieldName = 'VALOR_EIXO'
    end
    object QrPedagioNM_CIDADE: TStringField
      DisplayLabel = 'CIDADE'
      FieldName = 'NM_CIDADE'
      Size = 40
    end
    object QrPedagioID_SUBRLOGI: TFloatField
      FieldName = 'ID_SUBRLOGI'
    end
    object QrPedagioID_PEDAGIO_SUBREGIAO: TFloatField
      FieldName = 'ID_PEDAGIO_SUBREGIAO'
      Required = True
    end
  end
  object QrPed_SubReg: TOraQuery
    KeyFields = 'ID_PEDAGIO_SUBREGIAO'
    KeySequence = 'SEQCA_PEDAGIO_SUBREGIAO'
    SQLInsert.Strings = (
      'INSERT INTO CA_PEDAGIO_SUBREGIAO'
      '  (ID_PEDAGIO_SUBREGIAO, ID_PEDAGIO, ID_SUBRLOGI)'
      'VALUES'
      '  (:ID_PEDAGIO_SUBREGIAO, :ID_PEDAGIO, :ID_SUBRLOGI)')
    SQLDelete.Strings = (
      'DELETE FROM CA_PEDAGIO_SUBREGIAO'
      'WHERE'
      '  ID_PEDAGIO_SUBREGIAO = :ID_PEDAGIO_SUBREGIAO')
    SQLUpdate.Strings = (
      'UPDATE CA_PEDAGIO_SUBREGIAO'
      'SET'
      '  ID_PEDAGIO_SUBREGIAO = :ID_PEDAGIO_SUBREGIAO,'
      '  ID_PEDAGIO = :ID_PEDAGIO,'
      '  ID_SUBRLOGI = :ID_SUBRLOGI'
      'WHERE'
      '  ID_PEDAGIO_SUBREGIAO = :OLD_ID_PEDAGIO_SUBREGIAO')
    SQLLock.Strings = (
      'SELECT * FROM CA_PEDAGIO_SUBREGIAO'
      'WHERE'
      '  ID_PEDAGIO_SUBREGIAO = :ID_PEDAGIO_SUBREGIAO'
      'FOR UPDATE NOWAIT')
    SQLRefresh.Strings = (
    ...
    Left = 576
    Top = 16
    object QrPed_SubRegID_PEDAGIO_SUBREGIAO: TFloatField
      AutoGenerateValue = arAutoInc
      FieldName = 'ID_PEDAGIO_SUBREGIAO'
      Required = True
    end
    object QrPed_SubRegID_PEDAGIO: TFloatField
      FieldName = 'ID_PEDAGIO'
      Required = True
    end
    object QrPed_SubRegID_SUBRLOGI: TFloatField
      FieldName = 'ID_SUBRLOGI'
      Required = True
    end
  end
  object DSpedagio: TDataSource
    DataSet = QrPedagio
    Left = 528
    Top = 40
  end
