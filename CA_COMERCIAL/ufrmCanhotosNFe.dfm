object frmCanhotosNfe: TfrmCanhotosNfe
  Left = 535
  Top = 190
  Width = 1305
  Height = 675
  HorzScrollBar.Range = 803
  VertScrollBar.Range = 1184
  Caption = 'Canhotos NF-e'
  Color = clBackground
  ...
  object RLReport1: TRLReport
    ...
    object Cabecalho01: TRLBand
      ...
      object lblEntrega: TRLLabel
        Left = -1
        Top = 10
        Width = 141
        Height = 16
        AutoSize = False
        Caption = 'ENTREGA CARGA:'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = 15
        Font.Name = 'Arial'
    ...
    object Detalhes: TRLBand
      ...
      object RLPanel1: TRLPanel
        ...
        object RLLabel1: TRLLabel
          ...
          AutoSize = False
          Caption = 
            'RECEBEMOS DE AV'#205'COLA DACAR LTDA OS PRODUTOS DO PEDIDO / NOTA FIS' +
            'CAL INDICADA AO LADO'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = 11
          Font.Name = 'Arial'
      ...
      object RLPanel4: TRLPanel
        ...
        object RLLabel3: TRLLabel
          ...
          Height = 11
          AutoSize = False
          Caption = 'CARIMBO E/OU ASSINATURA DO RECEBEDOR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = 9
          Font.Name = 'Arial'
  ...
  object qryCanhotosNfe: TOraQuery
    Session = FrmPrincipal.DB
    SQL.Strings = (
      'SELECT DISTINCT CG.ID_CARGEXPE, '
      '                NF.NR_NOTAFISC, '
      '                CG.DT_CARGEXPE, '
      
        '                SUBSTR(CG.GN_PLACVEICTRAN,1,3) ||'#39' - '#39'|| SUBSTR(' +
        'CG.GN_PLACVEICTRAN,4,4) AS PLACA,'
      '                VW.DESCR, '
      
        '                VW.ENDERECO || '#39', '#39' || VW.END_NUMERO ||'#39' - '#39'|| V' +
        'W.BAIRRO || '#39', '#39' || VW.CIDADE || '#39'/'#39' || VW.UF AS ENDERECO,'
      
        '                VW.CNPJ || '#39'   IE: '#39'|| VW.INSCRICAO_ESTADUAL AS ' +
        'CNPJ_IE, '#39'PV - '#39'||PNF.ID_PEDIVEND AS PEDIDO                    '
      'FROM NOTA_FISCAL NF '
      'LEFT OUTER JOIN VWCA_BASE VW ON (VW.FILIAL = NF.FILIAL)'
      
        'INNER JOIN PEDIDO_VENDA_NOTA_FISCAL PNF ON(PNF.ID_NOTAFISC = NF.' +
        'ID_NOTAFISC)'
      
        'LEFT OUTER JOIN EXPEDICAO_CARGA_ITEM EXP ON (EXP.ID_PEDIVEND = P' +
        'NF.ID_PEDIVEND)'
      
        'INNER JOIN EXPEDICAO_CARGA CG ON (CG.ID_CARGEXPE = EXP.ID_CARGEX' +
        'PE)'
      'WHERE CG.ID_CARGEXPE = :ID_CARGEXPE AND NF.FL_CANCNOTAFISC = '#39'N'#39
    ...
    object qryCanhotosNfeID_CARGEXPE: TFloatField
      FieldName = 'ID_CARGEXPE'
      Required = True
    end
    object qryCanhotosNfeNR_NOTAFISC: TFloatField
      FieldName = 'NR_NOTAFISC'
      Required = True
    end
    object qryCanhotosNfeDT_CARGEXPE: TDateTimeField
      FieldName = 'DT_CARGEXPE'
      Required = True
    end
    object qryCanhotosNfeDESCR: TStringField
      FieldName = 'DESCR'
      Size = 60
    end
    object qryCanhotosNfeENDERECO: TStringField
      FieldName = 'ENDERECO'
      Size = 148
    end
    object qryCanhotosNfeCNPJ_IE: TStringField
      FieldName = 'CNPJ_IE'
      Size = 40
    end
    object qryCanhotosNfePLACA: TStringField
      FieldName = 'PLACA'
      Size = 7
    end
    object qryCanhotosNfePEDIDO: TStringField
      FieldName = 'PEDIDO'
      Size = 42
    end
  end
  object dtsCanhotosNfe: TOraDataSource
    DataSet = qryCanhotosNfe
    Left = 768
    Top = 40
  end
end
