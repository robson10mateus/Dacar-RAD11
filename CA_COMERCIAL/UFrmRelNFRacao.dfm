object FrmRelNFRacao: TFrmRelNFRacao
  Left = 572
  Top = 232
  Width = 792
  Height = 547
  ...
  VertScrollBar.Range = 589
  Caption = 'FrmRelNFRacao'
  Color = clBackground
  ...
  object qryNotaFisc: TOraQuery
    ...
    SQL.Strings = (
      ...
      '    FROM NOTA_FISCAL Nota_fiscal,'
        ...
        'l'
      ' WHERE (Pedido_venda_nota_fiscal.ID_PEDIVEND = :pi_pedivend)'
      
        '       AND (Pedido_venda_nota_fiscal.ID_NOTAFISC = Nota_fiscal.I' +
        'D_NOTAFISC)'
