...
procedure TFrmPlanoContas.Sb_SairClick(Sender: TObject);
begin
   Qr.Close;
   Close;
//   QrVENDEDOR.Close;
...
procedure TFrmPlanoContas.SB_PRIMEIROClick(Sender: TObject);
begin
  Qr.First;
end;

procedure TFrmPlanoContas.SB_ANTERIORClick(Sender: TObject);
begin
  Qr.Prior;
end;

procedure TFrmPlanoContas.SB_PROXIMOClick(Sender: TObject);
begin
  Qr.Next;
end;

procedure TFrmPlanoContas.SB_ULTIMOClick(Sender: TObject);
begin
  Qr.Last;
end;

procedure TFrmPlanoContas.SB_NOVOClick(Sender: TObject);
begin
//  Qr.Append;
...
procedure TFrmPlanoContas.SB_CONFIRMAClick(Sender: TObject);
begin
...
procedure TFrmPlanoContas.SB_CANCELClick(Sender: TObject);
begin
  Qr.CancelUpdates;
  Atual_ToolBar(10);
end;

procedure TFrmPlanoContas.SB_EXCLUIClick(Sender: TObject);
begin
...
procedure TFrmPlanoContas.Button1Click(Sender: TObject);
var
  Bitmap : TBitMap;
begin
...
procedure TFrmPlanoContas.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure TFrmPlanoContas.SB_EDITClick(Sender: TObject);
begin
  Qr.Edit;
  Atual_ToolBar(7);
end;

procedure TFrmPlanoContas.RadioGroup1Click(Sender: TObject);
VAR
  Vsitu:integer;
begin
...
procedure TFrmPlanoContas.QrCBRBeforePost(DataSet: TDataSet);
begin
...
procedure TFrmPlanoContas.LCamposClick(Sender: TObject);
begin
 SELPE:=0;
...
procedure TFrmPlanoContas.FormActivate(Sender: TObject);
begin
...
procedure TFrmPlanoContas.EdExpreChange(Sender: TObject);
begin
  BtIncluir.Enabled:=true;
end;

procedure TFrmPlanoContas.BtLimparClick(Sender: TObject);
begin
  EdExpre.Text:='';
  MResul.Clear;
  EdExpre.SetFocus;
...
procedure TFrmPlanoContas.BtIncluirClick(Sender: TObject);
var
  Vre,Vlinha:String;
  Vcampos:integer;
begin
...
procedure TFrmPlanoContas.BtAtivarClick(Sender: TObject);
VAR
  XTM:INTEGER;
Begin
// TRY
...
Function  TFrmPlanoContas.Bot_Flat(Botao:Integer):string;
begin
...
Function TFrmPlanoContas.Atual_ToolBar(BtOrdem: Integer): string;
begin
 CASE BtOrdem of
   5,7:begin
...
procedure TFrmPlanoContas.SB_ATUALClick(Sender: TObject);
begin
  Qr.Refresh;
end;

procedure TFrmPlanoContas.SB_PRIMEIROMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
 Bot_Flat(1);
end;

procedure TFrmPlanoContas.SB_ANTERIORMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(2);
end;

procedure TFrmPlanoContas.SB_PROXIMOMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(3);
end;

procedure TFrmPlanoContas.SB_ULTIMOMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(4);
end;

procedure TFrmPlanoContas.SB_NOVOMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(5);
end;

procedure TFrmPlanoContas.SB_EXCLUIMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(6);
end;

procedure TFrmPlanoContas.SB_EDITMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(7);
end;

procedure TFrmPlanoContas.SB_ATUALMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(8);
end;

procedure TFrmPlanoContas.SB_CONFIRMAMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(9);
end;

procedure TFrmPlanoContas.SB_CANCELMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(10);
end;

procedure TFrmPlanoContas.Sb_SairMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(11);
end;

procedure TFrmPlanoContas.ToolButton3MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(0);
end;

procedure TFrmPlanoContas.ToolBar1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(0);
end;

procedure TFrmPlanoContas.ToolButton2MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(0);
end;

procedure TFrmPlanoContas.ToolButton1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(0);
end;

procedure TFrmPlanoContas.PageControl1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  Bot_Flat(0);
end;
