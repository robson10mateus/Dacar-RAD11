object FrmParamComercial: TFrmParamComercial
  Left = 201
  Top = 121
  Width = 800
  Height = 553
    ...
    object TabLista: TTabSheet
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'FL_TRAVAQN'
            Title.Caption = 'Tra. Vl.'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'FL_TRAVAKG'
            Title.Caption = 'Tra. Kg'
            Visible = True
          end
          item
            Expanded = False
    ...
    object TabDetalhe: TTabSheet
      ...
      object Panel2: TPanel
        ...
        object GroupBox1: TGroupBox
          ...
          object SB_EXCLUIITEM: TSpeedButton
            Left = 46
            Top = 22
            Width = 39
            Height = 37
          ...
          object SB_CONFIRMAITEM: TSpeedButton
            Left = 101
            Top = 22
            Width = 40
            Height = 37
            ...
            ParentShowHint = False
            ShowHint = True
            OnClick = SB_CONFIRMAITEMClick
          end
          object SB_CANCELITEM: TSpeedButton
            Left = 141
            Top = 22
            Width = 40
            Height = 37
        ...
        object DBCheckBox2: TDBCheckBox
          ...
          Width = 94
          Height = 28
          Caption = 'Trava Pre'#231'o'
          DataField = 'FL_TRAVAQN'
          DataSource = DS
          TabOrder = 3
          ValueChecked = 'S'
          ValueUnchecked = 'N'
        ...
        object DBCheckBox3: TDBCheckBox
          ...
          Width = 91
          Height = 28
          Caption = 'Kg. at'#233' Cota'
          DataField = 'FL_TRAVAKG'
          DataSource = DS
          TabOrder = 2
          ValueChecked = 'S'
          ValueUnchecked = 'N'
      ...
      object DBCheckBox1: TDBCheckBox
        ...
        Width = 183
        Height = 28
        Caption = 'Kgs. 20% Abaixo Cota (Carga)'
        DataField = 'FL_TRAVAKGMIN'
        DataSource = DS
        TabOrder = 7
        ValueChecked = 'S'
        ValueUnchecked = 'N'
      end
      object BPesqPlaca: TBitBtn
        Left = 118
        Top = 94
        Width = 20
        Height = 20
        ...
        ParentFont = False
        TabOrder = 3
        OnClick = BPesqPlacaClick
      end
      object BtPesqVend: TBitBtn
        Left = 119
        Top = 155
        Width = 20
        Height = 20
  ...
  object Qr: TOraQuery
    KeyFields = 'ID_PARAMETRO'
    KeySequence = 'SEQCA_PARAMETRO_COMERCIAL'
    SQLInsert.Strings = (
      'INSERT INTO CA_PARAMETRO_COMERCIAL'
      
        '  (EMPRESA, FILIAL, ID_PARAMETRO, DT_PARAMETRO, GN_PLACVEICTRAN,' +
        ' ID_VENDEDOR, QN_COTA, VL_COTA, VL_PM, FL_TRAVAQN, FL_TRAVAKG, F' +
        'L_TRAVAKGMIN, ID_FORNECEDOR_TRANSPORTADOR)'
      'VALUES'
      
        '  (:EMPRESA, :FILIAL, :ID_PARAMETRO, :DT_PARAMETRO, :GN_PLACVEIC' +
        'TRAN, :ID_VENDEDOR, :QN_COTA, :VL_COTA, :VL_PM, :FL_TRAVAQN, :FL' +
        '_TRAVAKG, :FL_TRAVAKGMIN, :ID_FORNECEDOR_TRANSPORTADOR)')
    SQLDelete.Strings = (
      'DELETE FROM CA_PARAMETRO_COMERCIAL'
      'WHERE'
      '  ID_PARAMETRO = :ID_PARAMETRO')
    SQLUpdate.Strings = (
      'UPDATE CA_PARAMETRO_COMERCIAL'
      'SET'
      '  EMPRESA = :EMPRESA,'
      '  FILIAL = :FILIAL,'
      '  ID_PARAMETRO = :ID_PARAMETRO,'
      '  DT_PARAMETRO = :DT_PARAMETRO,'
      '  GN_PLACVEICTRAN = :GN_PLACVEICTRAN,'
      '  ID_VENDEDOR = :ID_VENDEDOR,'
      '  QN_COTA = :QN_COTA,'
      '  VL_COTA = :VL_COTA,'
      '  VL_PM = :VL_PM,'
      '  FL_TRAVAQN = :FL_TRAVAQN,'
      '  FL_TRAVAKG = :FL_TRAVAKG,'
      '  FL_TRAVAKGMIN = :FL_TRAVAKGMIN,'
      '  ID_FORNECEDOR_TRANSPORTADOR = :ID_FORNECEDOR_TRANSPORTADOR'
      'WHERE'
      '  ID_PARAMETRO = :OLD_ID_PARAMETRO')
    SQLLock.Strings = (
      'SELECT * FROM CA_PARAMETRO_COMERCIAL'
      'WHERE'
      '  ID_PARAMETRO = :ID_PARAMETRO'
      'FOR UPDATE NOWAIT')
    SQLRefresh.Strings = (
    ...
    SQL.Strings = (
      'SELECT'
      '  CA_PARAMETRO_COMERCIAL.EMPRESA,'
      '  CA_PARAMETRO_COMERCIAL.FILIAL,'
      '  CA_PARAMETRO_COMERCIAL.ID_PARAMETRO,'
      '  CA_PARAMETRO_COMERCIAL.DT_PARAMETRO,'
      '  CA_PARAMETRO_COMERCIAL.GN_PLACVEICTRAN,'
      '  CA_PARAMETRO_COMERCIAL.ID_VENDEDOR,'
      '  CA_PARAMETRO_COMERCIAL.QN_COTA,'
      '  CA_PARAMETRO_COMERCIAL.VL_COTA,'
      '  CA_PARAMETRO_COMERCIAL.VL_PM,'
      ...
      '  FRETE_ABATIDO.VL_QUILFRETABAT,'
      '  CA_PARAMETRO_COMERCIAL.ID_PRODMATEEMBA,'
      '  CA_PARAMETRO_COMERCIAL.FL_TRAVAKG,'
      '  CA_PARAMETRO_COMERCIAL.FL_TRAVAKGMIN,'
      '  CA_PARAMETRO_COMERCIAL.ID_FORNECEDOR_TRANSPORTADOR'
      'FROM'
      ...
      'WHERE'
        ...
        '  (VENDEDOR.ID_VENDEDOR (+) = CA_PARAMETRO_COMERCIAL.ID_VENDEDOR' +
        ') AND'
      
        '  TRANSPORTADOR_VEICULO.GN_PLACVEICTRAN = CA_PARAMETRO_COMERCIAL' +
        '.GN_PLACVEICTRAN AND'
      ...
      '  VEICULO_TIPO.ID_TIPOVEIC = FRETE_ABATIDO.ID_TIPOVEIC AND'
        ...
        '  TRANSPORTADOR_VEICULO.ID_FORNECEDOR_TRANSPORTADOR =  CA_PARAME' +
        'TRO_COMERCIAL.ID_FORNECEDOR_TRANSPORTADOR')
    CachedUpdates = True
    Left = 440
    Top = 8
    ...
    object QrID_PARAMETRO: TFloatField
      AutoGenerateValue = arAutoInc
      DisplayLabel = 'C'#243'd.'
      FieldName = 'ID_PARAMETRO'
      Required = True
    end
    object QrDT_PARAMETRO: TDateTimeField
      DisplayLabel = 'Data'
      FieldName = 'DT_PARAMETRO'
    end
    ...
    object QrQN_COTA: TFloatField
      DisplayLabel = 'Cota Kg.'
      FieldName = 'QN_COTA'
    end
    object QrVL_COTA: TFloatField
      DisplayLabel = 'Cota Valor'
      FieldName = 'VL_COTA'
      DisplayFormat = '#,##0.00###'
    end
    ...
    object QrFL_TRAVAQN: TStringField
      DisplayLabel = 'Trava'
      FieldName = 'FL_TRAVAQN'
      Size = 1
    end
    object QrQN_CAPATIPOVEIC: TFloatField
      DisplayLabel = 'Capac. Ve'#237'c.'
      FieldName = 'QN_CAPATIPOVEIC'
    end
    object QrQN_FATOFRETABATVEICTRAN: TFloatField
      DisplayLabel = 'Fator Frete'
      FieldName = 'QN_FATOFRETABATVEICTRAN'
    end
    object QrVL_QUILFRETABAT: TFloatField
      DisplayLabel = 'Valor Frete'
      FieldName = 'VL_QUILFRETABAT'
      DisplayFormat = '#,##0.00###'
    end
    object QrFL_TRAVAKG: TStringField
      FieldName = 'FL_TRAVAKG'
      Size = 1
    end
    object QrFL_TRAVAKGMIN: TStringField
      FieldName = 'FL_TRAVAKGMIN'
      Size = 1
    end
    object QrID_FORNECEDOR_TRANSPORTADOR: TFloatField
  ...
  object QrItem: TOraQuery
    SQLInsert.Strings = (
      'INSERT INTO CA_PARAMETRO_COMERCIAL_ITEM'
      
        '  (ID_PARAMETRO, ID_PRODMATEEMBA, QN_COTA, VL_COTA, VL_PM, FL_TR' +
        'AVAITEM)'
      'VALUES'
      
        '  (:ID_PARAMETRO, :ID_PRODMATEEMBA, :QN_COTA, :VL_COTA, :VL_PM, ' +
        ':FL_TRAVAITEM)')
    SQLDelete.Strings = (
      'DELETE FROM CA_PARAMETRO_COMERCIAL_ITEM'
      'WHERE'
      '  ID_PARAMETRO = :ID_PARAMETRO and'
      '  ID_PRODMATEEMBA = :ID_PRODMATEEMBA')
    SQLUpdate.Strings = (
      'UPDATE CA_PARAMETRO_COMERCIAL_ITEM'
      'SET'
      '  ID_PARAMETRO = :ID_PARAMETRO,'
      '  ID_PRODMATEEMBA = :ID_PRODMATEEMBA,'
      '  QN_COTA = :QN_COTA,'
      '  VL_COTA = :VL_COTA,'
      '  VL_PM = :VL_PM,'
      '  FL_TRAVAITEM = :FL_TRAVAITEM'
      'WHERE'
      '  ID_PARAMETRO = :OLD_ID_PARAMETRO and'
      '  ID_PRODMATEEMBA = :OLD_ID_PRODMATEEMBA')
    SQLLock.Strings = (
      'SELECT * FROM CA_PARAMETRO_COMERCIAL_ITEM'
      'WHERE'
      '  ID_PARAMETRO = :ID_PARAMETRO and'
      '  ID_PRODMATEEMBA = :ID_PRODMATEEMBA'
      'FOR UPDATE NOWAIT')
    ...
    SQL.Strings = (
      'SELECT'
      '  CA_PARAMETRO_COMERCIAL_ITEM.ID_PARAMETRO,'
      '  CA_PARAMETRO_COMERCIAL_ITEM.ID_PRODMATEEMBA,'
      '  CA_PARAMETRO_COMERCIAL_ITEM.QN_COTA,'
      '  CA_PARAMETRO_COMERCIAL_ITEM.VL_COTA,'
      '  CA_PARAMETRO_COMERCIAL_ITEM.VL_PM,'
      '  CA_PARAMETRO_COMERCIAL_ITEM.FL_TRAVAITEM,'
      ...
      'WHERE'
        ...
        '    MATERIAL_EMBALAGEM.ID_PRODMATEEMBA = CA_PARAMETRO_COMERCIAL_' +
        'ITEM.ID_PRODMATEEMBA'
      'AND CA_PARAMETRO_COMERCIAL_ITEM.ID_PARAMETRO = :ID_PARAMETRO ')
    MasterSource = DS
    CachedUpdates = True
    Left = 528
    Top = 8
    ...
    object QrItemID_PARAMETRO: TFloatField
      DisplayLabel = 'Id. Parametro'
      FieldName = 'ID_PARAMETRO'
      Required = True
    end
    object QrItemID_PRODMATEEMBA: TStringField
      DisplayLabel = 'Id. Mat./Emb.'
      FieldName = 'ID_PRODMATEEMBA'
      Required = True
      Size = 3
    end
    object QrItemNM_PRODMATEEMBA: TStringField
      DisplayLabel = 'Material Embalagem'
      FieldName = 'NM_PRODMATEEMBA'
      Size = 40
    end
    object QrItemQN_COTA: TFloatField
      DisplayLabel = 'Cota Kg.'
      FieldName = 'QN_COTA'
    end
    object QrItemVL_COTA: TFloatField
      DisplayLabel = 'Vl. Cota'
      FieldName = 'VL_COTA'
      DisplayFormat = '#,##0.00###'
    end
    object QrItemVL_PM: TFloatField
      DisplayLabel = 'Pre'#231'o Med.'
      FieldName = 'VL_PM'
      DisplayFormat = '#,##0.00###'
    end
    object QrItemFL_TRAVAITEM: TStringField
      DisplayLabel = 'Trava Item'
      FieldName = 'FL_TRAVAITEM'
      Size = 1
    end
  end
