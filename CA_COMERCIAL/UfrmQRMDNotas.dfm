object frmQRMDNotas: TfrmQRMDNotas
  Left = 89
  Top = 69
  Width = 865
  Height = 623
  HorzScrollBar.Range = 824
  VertScrollBar.Range = 1056
  Caption = 'frmQRMDNotas'
  Color = clBackground
  ...
  object qryNotaFisc: TOraQuery
    ...
    SQL.Strings = (
      ...
      '               Nota_fiscal.VL_IPINOTAFISC, '
        ...
        '               DECODE(Nota_fiscal.ID_CLIENTE,6684,Nota_fiscal.VL' +
        '_PRODNOTAFISC,'
      ...
      '       AND (Pedido_venda_nota_fiscal.ID_PEDIVEND = :pi_pedivend)'
        ...
        'isc)'
      '       AND (Nota_Fiscal.FL_CANCNOTAFISC = :VCANCEL)'
      '       AND (Nota_fiscal.NR_NOTAFISC = :VNOTA)')
    Left = 136
    Top = 280
    ParamData = <
      item
