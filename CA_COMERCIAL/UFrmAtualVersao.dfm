object FrmAtualVersao: TFrmAtualVersao
  Left = 110
  Top = 103
  Width = 631
  Height = 473
  ...
  object QR: TOraQuery
    SQLInsert.Strings = (
      'INSERT INTO GMODULO'
        ...
        '  (MODCODIGO, MODAPELIDO, MODNOME, MODATIVO, MODVERSAO, MODPATHA' +
        'TUALIZACAO)'
      'VALUES'
      
        '  (:MODCODIGO, :MODAPELIDO, :MODNOME, :MODATIVO, :MODVERSAO, :MO' +
        'DPATHATUALIZACAO)')
    SQLDelete.Strings = (
      'DELETE FROM GMODULO'
      'WHERE'
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
      '  MODCODIGO = :MODCODIGO,'
      '  MODAPELIDO = :MODAPELIDO,'
      '  MODNOME = :MODNOME,'
      '  MODATIVO = :MODATIVO,'
      '  MODVERSAO = :MODVERSAO,'
      '  MODPATHATUALIZACAO = :MODPATHATUALIZACAO'
      'WHERE'
      '  MODCODIGO = :OLD_MODCODIGO')
    SQLLock.Strings = (
      'SELECT * FROM GMODULO'
      'WHERE'
      '  MODCODIGO = :MODCODIGO'
    ...
    Left = 280
    Top = 8
    object QRMODCODIGO: TStringField
      DisplayLabel = 'C'#243'digo'
      FieldName = 'MODCODIGO'
      Required = True
      Size = 1
    end
    object QRMODAPELIDO: TStringField
      DisplayLabel = 'Apelido'
      FieldName = 'MODAPELIDO'
      Size = 10
    end
    object QRMODNOME: TStringField
      DisplayLabel = 'Descri'#231#227'o'
      FieldName = 'MODNOME'
      Size = 100
    end
    object QRMODATIVO: TStringField
      DisplayLabel = 'Ativo'
      FieldName = 'MODATIVO'
      Size = 1
    end
    object QRMODVERSAO: TStringField
      DisplayLabel = 'Vers'#227'o'
      FieldName = 'MODVERSAO'
      Size = 8
    end
    object QRMODPATHATUALIZACAO: TStringField
      DisplayLabel = 'Path Atualiza'#231#227'o'
      FieldName = 'MODPATHATUALIZACAO'
      Size = 60
    end
  end
  object DSAtualVersao: TOraDataSource
    DataSet = QR
    Left = 320
    Top = 8
  end
