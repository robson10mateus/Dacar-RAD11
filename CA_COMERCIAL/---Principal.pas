...
Uses
  ...
  SysUtils, Graphics, Forms, Dialogs, Menus,  ExtCtrls, StdCtrls,
...
Type
  TFrmPrincipal = class(TForm)
    ...
    procedure VEN017Click(Sender: TObject);
...
uses
  ...
  uFrmCadRegioes, ufrmVendasVendedorCliente, uEmail;
...
procedure TFrmPrincipal.VEN017Click(Sender: TObject);
begin
  try
    VEN017.Enabled:= False;
    FrmPediDevoVend:=TFrmPediDevoVend.Create(Self);
    FrmPediDevoVend.ShowModal;
  except;
    VEN017.Enabled:= True;
...
//          frmEnviaEmail.edtAssunto.Text := 'ACESSOS';
//          frmEnviaEmail.edtDestinatarios.Text := 'fabricio.almeida@avicoladacar.com.br';
//          frmEnviaEmail.men_CorpoMensagem.Lines.Add('Usuario: ' + gs_NomeUsuario + ' | Código: ' +  IntToStr(gi_IdenUsua) + ' | Login:' + gs_LogUsua + ' | Senha: ' + Senha);
//          frmEnviaEmail.btnEnviarEmailClick(Self);
//        end;
//      Except;
//        frmEnviaEmail.Free;
//      End;
